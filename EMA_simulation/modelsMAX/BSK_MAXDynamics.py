...
class BSKDynamicModels:
    ...
    def __init__(self, SimBase, dynRate, spacecraftIndex):
        ...
        self.platform = spinningBodyTwoDOFStateEffector.SpinningBodyTwoDOFStateEffector()
    ...
    def SetRotatingSolarArrays(self):
        ...
        self.RSAList[0].r_SB_B = [0.75, 0, 0.75]
        self.RSAList[0].r_ScS_S = [3.7, 0, 0]
        self.RSAList[0].sHat_S = [1, 0, 0]
        self.RSAList[0].dcm_S0B = [[1, 0, 0], [0, 1, 0], [0, 0, 1]]
        self.RSAList[0].IPntSc_S = [[17.5, 0, 0], [0, 35, 0], [0, 0, 17.5]]
        ...
        self.RSAList[1].r_SB_B = [-0.75, 0, 0.75]
        self.RSAList[1].r_ScS_S = [3.7, 0, 0]
        self.RSAList[1].sHat_S = [1, 0, 0]
        self.RSAList[1].dcm_S0B = [[-1, 0, 0], [0, 1, 0], [0, 0, -1]]
        self.RSAList[1].IPntSc_S = [[17.5, 0, 0], [0, 35, 0], [0, 0, 17.5]]
    ...
    def SetInertialBoresight(self, SimBase):
        ...
        self.inertialBoresight.scStateInMsg.subscribeTo(self.platform.spinningBodyConfigLogOutMsgs[1])
    ...
    def SetPlatform(self):
        ...
        """
        self.platform.theta1Init = 0
        self.platform.theta1DotInit = 0
        self.platform.theta2Init = 0
        self.platform.theta2DotInit = 0
        self.platform.mass1 = 5
        self.platform.mass2 = 5
        self.platform.k1 = 0
        self.platform.k2 = 0
        self.platform.r_S1B_B = [0, 0, -1.6]
        self.platform.r_S2S1_S1 = [0, 0, 0]
        self.platform.r_Sc1S1_S1 = [0, 0, 0]
        self.platform.r_Sc2S2_S2 = [0, 0, 0]
        self.platform.s1Hat_S1 = [1, 0, 0]
        self.platform.s2Hat_S2 = [0, 1, 0]
        self.platform.IS1PntSc1_S1 = [[2, 0, 0], [0, 3, 0], [0, 0, 4]]
        self.platform.IS2PntSc2_S2 = [[2, 0, 0], [0, 3, 0], [0, 0, 4]]
        self.platform.dcm_S10B = [[1, 0, 0], [0, 1, 0], [0, 0, 1]]
        self.platform.dcm_S20S1 = [[1, 0, 0], [0, 1, 0], [0, 0, 1]]
