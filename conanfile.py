...
def is_conan_package_available(ref: str):
    ...
    try:
        output = subprocess.check_output(
            [sys.executable, "-m", "conans.conan", "list", ref, "-r=*", "-c", "-f", "json", "-verror"],
...
if __name__ == "__main__":
    ...
    if args.mujocoReplay:
        ...
        subprocess.run([sys.executable, "-m", "conans.conan", "build", ".", "-s" ,"compiler.cppstd=17"], cwd="./src/utilities/mujocoUtils" )
