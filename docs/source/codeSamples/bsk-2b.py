...
def run():
    ...
    fswProcess.addTask(scSim.CreateNewTask("fswTask2", macros.sec2nano(1.)))
    fswProcess.addTask(scSim.CreateNewTask("fswTask3", macros.sec2nano(1.)), 10)
    dynProcess.addTask(scSim.CreateNewTask("dynamicsTask1", macros.sec2nano(1.)))
    dynProcess.addTask(scSim.CreateNewTask("dynamicsTask2", macros.sec2nano(1.)), 10)
    dynProcess.addTask(scSim.CreateNewTask("dynamicsTask3", macros.sec2nano(1.)))
