...
generator, and versions of the principal build tools in the installed Python package, including a wheel.
Rust-enabled builds also record the Rust compiler and target, Cargo, and Corrosion.  This information can be
