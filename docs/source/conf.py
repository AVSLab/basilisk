...
import warnings # from scylladb
from datetime import date # from scylladb

import numpy as np
from sphinx_scylladb_theme.utils import multiversion_regex_builder

sys.path.insert(0, os.path.abspath("..")) # scylladb
...
# -- Global variables from scylladb
# Build documentation for the following tags and branches
TAGS = ["2.1.6"]
# BRANCHES = ["develop", "new_branch"]
BRANCHES = ["develop"]
...
extensions = [
    ...
    "sphinx.ext.napoleon",
    "sphinx_sitemap",
    "sphinx_scylladb_theme", #"sphinx_rtd_theme",
    "sphinx.ext.viewcode",
...
html_theme_options = {
    ...
    "hide_banner": "true",
    "github_issues_repository": "AVSLab/basilisk",
    "github_repository": "AVSLab/basilisk",
...
html_baseurl = "https://AVSLab.github.io/basilisk"
