...
- :ref:`scenarioAerobrake` branches a :ref:`facetDragDynamicEffector` onto each of two
  :ref:`hingedRigidBodyStateEffector` solar panels on a strongly elliptical Earth aerobraking
...
:ref:`scenarioBranchingVerification` verifies the branched equations of motion rather than
demonstrating a configuration. It refines the integration step to confirm the branched path holds
the integrator's formal order, and checks the branched wrench against the impulse-momentum
