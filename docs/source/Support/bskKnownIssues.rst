...
- GitHub issue 281: Draft module tests generated by :ref:`makeDraftModule` previously
  reported success without checking execution or outputs. Newly generated tests check
  scheduled call counts, output written status, and recording and write timestamps.
  Existing module tests must be updated manually; regenerating a draft replaces its folder.
