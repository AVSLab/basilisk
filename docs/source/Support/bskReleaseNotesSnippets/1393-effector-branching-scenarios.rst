...
- Added :ref:`scenarioBranchingVerification`, which verifies the branched equations of motion against the integrator's formal order and the impulse-momentum theorems.
