...
- Refactored how Custom.cmake files are included and how they are to be constructed. Custom.cmake files
  ...
  :ref:`src/cmake/bskTargetExcludeBuildOptions.cmake`. Most importantly, the build target is now accessible within the
  ...
  and after of the :ref:`src/cmake/usingOpenCV.cmake` file.
