...
def executeGuidance(TheAVSSim):
    ...
    TheAVSSim.ConfigureStopTime(int(15 * 1E9))
    TheAVSSim.ExecuteSimulation()
    TheAVSSim.modeRequest = 'hillPointMars'
    TheAVSSim.ConfigureStopTime(int(60 * 1.5 * 1E9))
    TheAVSSim.ExecuteSimulation()
    TheAVSSim.modeRequest = 'cel2bdyPoint_ME'
    TheAVSSim.ConfigureStopTime(int(60 * 1.5 * 1E9))
    TheAVSSim.ExecuteSimulation()
...
if __name__ == "__main__":
    ...
    TheAVSSim.VehOrbElemObject.CurrentElem.e = 0.6
