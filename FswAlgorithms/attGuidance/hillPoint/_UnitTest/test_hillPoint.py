...
from Basilisk.modules import hillPoint                        # import the module that is to be tested
from Basilisk.modules import cheby_pos_ephem
...
def hillPointTestFunction(show_plots):
    ...
    #
    NavStateOutData = hillPoint.NavTransIntMsg()  # Create a structure for the input message
