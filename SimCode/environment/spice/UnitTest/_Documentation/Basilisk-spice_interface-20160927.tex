...
\begin{table}[htbp]
   ...
   \begin{tabular}{c | c | c | c | c | c | c} % Column formatting, 
      ...
      04/10/16 & \textcolor{red}{Failed} & \textcolor{red}{Failed} &  \textcolor{ForestGreen}{Passed}&  \textcolor{ForestGreen}{Passed} & \textcolor{ForestGreen}{Passed} &  \textcolor{ForestGreen}{Passed}\\
...
\begin{figure}[htb]
	\centerline{
	\includegraphics[scale=0.65]{Figures/Ephem2.png}
	}
...
\begin{figure}[htb]
	\centerline{
	\includegraphics[scale=0.65]{Figures/EphemEarth2.png}
	}
...
\begin{figure}[htb]
	\centerline{
	\includegraphics[scale=0.65]{Figures/EphemSun2.png}
	}
