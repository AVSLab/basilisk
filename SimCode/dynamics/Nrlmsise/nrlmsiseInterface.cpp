...
NrlmsiseInterface::NrlmsiseInterface()
    : stepsInRamp(30)
...
/*! This method is used to clear out the current thruster states and make sure
 ...
 @return void
 */
void NrlmsiseInterface::SelfInit()
{
    //! Begin method steps
...
/*! This method is used to connect the input command message to the thrusters.
 ...
 @return void
 */
void NrlmsiseInterface::CrossInit()
{
...
/*! This method is here to write the output message structure into the specified
 ...
 @return void
 */
void NrlmsiseInterface::WriteOutputMessages(uint64_t CurrentClock)
{
    int idx = 0;
    std::vector<ThrusterConfigData>::iterator it;
...
/*! This method is used to read the incoming command message and set the
 ...
 @return void
 */
bool NrlmsiseInterface::ReadInputs()
{
 ...
 */
void NrlmsiseInterface::ConfigureThrustRequests(double currentTime)
{
    //! Begin method steps
    std::vector<ThrusterConfigData>::iterator it;
    std::vector<double>::iterator CmdIt;
...
void NrlmsiseInterface::linkInStates(DynParamManager& states){
    this->hubSigma = states.getStateObject("hubSigma");
    this->dcm_BS = states.getPropertyReference(inputBSName);
}


void NrlmsiseInterface::computeBodyForceTorque(double integTime){
...
void NrlmsiseInterface::computeStateContribution(double integTime){
 ...
 */
void NrlmsiseInterface::ComputeThrusterFire(ThrusterConfigData *CurrentThruster,
                                           double currentTime)
{
    //! Begin method steps
...
/*! This method is used to go through the process of shutting down a thruster
 ...
 @param CurrentTime The current simulation clock time converted to a double
 */
void NrlmsiseInterface::ComputeThrusterShut(ThrusterConfigData *CurrentThruster,
                                           double currentTime)
{
    //! Begin method steps
    std::vector<ThrusterTimePair>::iterator it;
 ...
 */
double NrlmsiseInterface::thrFactorToTime(ThrusterConfigData *thrData,
 ...
 */
void NrlmsiseInterface::UpdateState(uint64_t CurrentSimNanos)
{
    //! Begin method steps
