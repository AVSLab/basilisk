...
\begin{table}[htbp]
	...
	\begin{tabular}{ c | c } % Column formatting, 
		...
		Setup Test                           			 & \input{AutoTex/sphericalHarmonicsAccuracy}		   \\ 
		Independent Spherical Harmonics Check  & \input{AutoTex/independentCheckAccuracy}		   \\ 
		Single-Body Gravity						   & \input{AutoTex/singleBodyAccuracy}														   \\ 
