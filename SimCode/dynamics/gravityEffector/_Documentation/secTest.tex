...
\begin{table}[htbp]
	...
	\begin{tabular}{ c | c } % Column formatting, 
		...
		Setup Test                           			 & \input{AutoTex/sphericalHarmonicsAccuracy}		   \\ \hline
		Independent Spherical Harmonics Check  & \input{AutoTex/independentCheckAccuracy}		   \\ \hline
...
\begin{table}[htbp]
	...
	\begin{tabular}{c | c | c  } % Column formatting, 
		...
		Independent Spherical Harmonics Check  & \input{AutoTex/independentCheckPassFail}                 & \input{AutoTex/independentCheckFailMsg} \\ \hline
