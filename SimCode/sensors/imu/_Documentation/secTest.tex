...
\begin{table}[H]
	...
	\begin{tabular}{c | c | c  } % Column formatting, 
		...
		Clean	   			& \input{AutoTex/cleanpassFail}&  \input{AutoTex/cleanfailMessage}  		 \\ \hline
		Clean	   			& \input{AutoTex/noisepassFail}&  \input{AutoTex/noisefailMessage}   		 \\ \hline
		Clean	   			& \input{AutoTex/biaspassFail}&  \input{AutoTex/biasfailMessage} 		 \\ \hline
		Clean	   			& \input{AutoTex/saturationpassFail}&  \input{AutoTex/saturationfailMessage} 		 \\ \hline
		Clean	   			& \input{AutoTex/discretizationpassFail}&  \input{AutoTex/discretizationfailMessage}   		 \\ \hline
	\end{tabular}
\end{table}
