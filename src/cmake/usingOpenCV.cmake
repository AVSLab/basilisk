...
if(DEFINED opencv_INCLUDE_DIRS_DEBUG)
  set(DIRECTORIES
      "$<$<CONFIG:Debug>:${opencv_INCLUDE_DIRS_DEBUG}>" "$<$<CONFIG:Release>:${opencv_INCLUDE_DIRS_DEBUG}>"
      "$<$<CONFIG:RelWithDebInfo>:${opencv_INCLUDE_DIRS_DEBUG}>" "$<$<CONFIG:MinSizeRel>:${opencv_INCLUDE_DIRS_DEBUG}>")
else()
  set(DIRECTORIES
      "$<$<CONFIG:Debug>:${opencv_INCLUDE_DIRS_RELEASE}>" "$<$<CONFIG:Release>:${opencv_INCLUDE_DIRS_RELEASE}>"
