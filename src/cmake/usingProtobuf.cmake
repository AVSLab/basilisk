...
get_property(
  INCLUDE_DIRECTORY
  TARGET protobuf::protobuf
  PROPERTY INTERFACE_INCLUDE_DIRECTORIES)
if(DEFINED protobuf_INCLUDE_DIRS_DEBUG)
  set(DIRECTORIES
      "$<$<CONFIG:Debug>:${protobuf_INCLUDE_DIRS_DEBUG}>" "$<$<CONFIG:Release>:${protobuf_INCLUDE_DIRS_DEBUG}>"
      "$<$<CONFIG:RelWithDebInfo>:${protobuf_INCLUDE_DIRS_DEBUG}>"
      "$<$<CONFIG:MinSizeRel>:${protobuf_INCLUDE_DIRS_DEBUG}>")
else()
  set(DIRECTORIES
      "$<$<CONFIG:Debug>:${protobuf_INCLUDE_DIRS_RELEASE}>" "$<$<CONFIG:Release>:${protobuf_INCLUDE_DIRS_RELEASE}>"
