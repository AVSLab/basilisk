...
function(protobuf_generate)
  ...
  if(NOT protobuf_generate_GENERATE_EXTENSIONS)
    ...
    elseif(protobuf_generate_LANGUAGE STREQUAL python)
 	...
 	elseif(protobuf_generate_LANGUAGE STREQUAL cs)
      set(protobuf_generate_GENERATE_EXTENSIONS .cs)
    else()
...
function(PROTOBUF_GENERATE_CS SRCS)
  if(NOT ARGN)
    message(SEND_ERROR "Error: PROTOBUF_GENERATE_PYTHON() called without any proto files")
    return()
  endif()
  ...
  set(_outvar)
  protobuf_generate(${_append_arg} LANGUAGE cs OUT_VAR _outvar ${_import_arg} PROTOS ${ARGN})
  set(${SRCS} ${_outvar} PARENT_SCOPE)
endfunction()
