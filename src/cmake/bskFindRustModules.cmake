...
function(generate_rust_package_targets TARGET_LIST LIB_DEP_LIST MODULE_DIR)
  ...
  foreach(TARGET_FILE ${TARGET_LIST})
    ...
    # build.rs on a cold build. Depend on the real SWIG library target rather
    # than UseSWIG's Makefile-only <name>_swig_compilation helper so this
    # ordering also works with Ninja and multi-config generators.
