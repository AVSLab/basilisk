...
equalCheck(C, C_true, 'BmatEuler121', e_count)
...
equalCheck(C, C_true, 'BmatEuler123', e_count)
...
equalCheck(C, C_true, 'BmatEuler131', e_count)
...
equalCheck(C, C_true, 'BmatEuler132', e_count)
...
equalCheck(C, C_true, 'BmatEuler212', e_count)
...
equalCheck(C, C_true, 'BmatEuler213', e_count)
...
equalCheck(C, C_true, 'BmatEuler231', e_count)
...
equalCheck(C, C_true, 'BmatEuler232', e_count)
...
equalCheck(C, C_true, 'BmatEuler312', e_count)
...
equalCheck(C, C_true, 'BmatEuler313', e_count)
...
equalCheck(C, C_true, 'BmatEuler321', e_count)
...
equalCheck(C, C_true, 'BmatEuler323', e_count)
...
equalCheck(C, C_true, 'BinvGibbs', e_count)
...
equalCheck(C, C_true, 'BinvMRP', e_count)
C = rbk.BinvPRV(v)
C_true = np.array([
...
equalCheck(C, C_true, 'BinvPRV', e_count)
C = rbk.BmatGibbs(v)
C_true = np.array([
...
equalCheck(C, C_true, 'BmatGibbs', e_count)
C = rbk.BmatMRP(v)
C_true = np.array([
...
equalCheck(C, C_true, 'BmatMRP', e_count)
C = rbk.BmatPRV(v)
C_true = np.array([
...
equalCheck(C, C_true, 'BmatPRV', e_count)
...
equalCheck(v, v_true, 'elem2PRV', e_count)
...
equalCheck(C, C_true, 'EP2C', e_count)
v = rbk.EP2Euler121(q)
v_true = np.array([3.202098165750965, 2.102046098550739, -1.127921895439695])
equalCheck(v, v_true, 'EP2Euler121', e_count)
v = rbk.EP2Euler123(q)
v_true = np.array([1.395488250243478, 0.3784438476398376, 2.147410157986089])
equalCheck(v, v_true, 'EP2Euler123', e_count)
v = rbk.EP2Euler131(q)
v_true = np.array([1.631301838956069, 2.102046098550739, 0.4428744313552013])
equalCheck(v, v_true, 'EP2Euler131', e_count)
v = rbk.EP2Euler132(q)
v_true = np.array([-2.262757475208626, 0.8930615653924096, 2.511467464302149])
equalCheck(v, v_true, 'EP2Euler132', e_count)
v = rbk.EP2Euler212(q)
v_true = np.array([-2.125637903992466, 1.982395614047245, -0.05691616561213508])
equalCheck(v, v_true, 'EP2Euler212', e_count)
v = rbk.EP2Euler213(q)
v_true = np.array([1.157420789791818, 1.155503238813826, -3.012011225795042])
equalCheck(v, v_true, 'EP2Euler213', e_count)
v = rbk.EP2Euler231(q)
v_true = np.array([-2.102846464319881, -0.05215813778076988, 1.982990154077466])
equalCheck(v, v_true, 'EP2Euler231', e_count)
v = rbk.EP2Euler232(q)
v_true = np.array([-0.5548415771975691, 1.982395614047245, -1.627712492407032])
equalCheck(v, v_true, 'EP2Euler232', e_count)
v = rbk.EP2Euler312(q)
v_true = np.array([2.045248068737305, -0.5038614866151004, -1.384653359078797])
equalCheck(v, v_true, 'EP2Euler312', e_count)
v = rbk.EP2Euler313(q)
v_true = np.array([0.3837766626244828, 1.408008028147627, 2.082059614484753])
equalCheck(v, v_true, 'EP2Euler313', e_count)
v = rbk.EP2Euler321(q)
v_true = np.array([-3.039045355374235, -1.036440549977791, -1.246934586231547])
equalCheck(v, v_true, 'EP2Euler321', e_count)
v = rbk.EP2Euler323(q)
v_true = np.array([-1.187019664170414, 1.408008028147627, 3.65285594127965])
equalCheck(v, v_true, 'EP2Euler323', e_count)
v = rbk.EP2Gibbs(q)
v_true = np.array([1.692307692307693, -1.923076923076923, 2.846153846153846])
equalCheck(v, v_true, 'EP2Gibbs', e_count)
v = rbk.EP2MRP(q)
v_true = np.array([0.3413551595269481, -0.3879035903715319, 0.5740973137498672])
equalCheck(v, v_true, 'EP2MRP', e_count)
v = rbk.EP2PRV(q)
v_true = np.array([1.162634795241009, -1.321175903682965, 1.955340337450788])
equalCheck(v, v_true, 'EP2PRV', e_count)
...
equalCheck(C, C_true, 'euler1', e_count)
C = rbk.euler2(x)
C_true = np.array([
...
equalCheck(C, C_true, 'euler2', e_count)
C = rbk.euler3(x)
C_true = np.array([
...
equalCheck(C, C_true, 'euler3', e_count)
...
equalCheck(v, v_true, 'subEuler123', e_count)
v = rbk.subEuler231(e1, e2)
equalCheck(v, v_true, 'subEuler231', e_count)
v = rbk.subEuler312(e1, e2)
equalCheck(v, v_true, 'subEuler312', e_count)
v_true = np.array([2.932019083757663, 0.6246626379494424, -1.519867235625338])
v = rbk.subEuler132(e1, e2)
equalCheck(v, v_true, 'subEuler132', e_count)
v = rbk.subEuler213(e1, e2)
equalCheck(v, v_true, 'subEuler213', e_count)
v = rbk.subEuler321(e1, e2)
equalCheck(v, v_true, 'subEuler321', e_count)
v_true = np.array([2.969124082346242, 2.907100217278789, 2.423943306316236])
v = rbk.subEuler121(e1, e2)
equalCheck(v, v_true, 'subEuler121', e_count)
v = rbk.subEuler212(e1, e2)
equalCheck(v, v_true, 'subEuler212', e_count)
v = rbk.subEuler232(e1, e2)
equalCheck(v, v_true, 'subEuler232', e_count)
v = rbk.subEuler313(e1, e2)
equalCheck(v, v_true, 'subEuler313', e_count)
v = rbk.subEuler323(e1, e2)
equalCheck(v, v_true, 'subEuler323', e_count)
v = rbk.subEuler131(e1, e2)
equalCheck(v, v_true, 'subEuler131', e_count)
...
equalCheck(v, v_true, 'subGibbs', e_count)
v = rbk.subMRP(q1, q2)
v_true = np.array([0.02739726027397266, -0.2191780821917807, 2.246575342465753])
equalCheck(v, v_true, 'subMRP', e_count)
v = rbk.subPRV(q1, q2)
v_true = np.array([1.899971363060601, 0.06138537390284331, 0.7174863730592785])
equalCheck(v, v_true, 'subPRV', e_count)
...
equalCheck(C, C_true, 'Mi', e_count)
C = rbk.Mi(theta, 2)
C_true = np.array([
