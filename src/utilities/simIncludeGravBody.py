...
class BodyData:
    ...
    Args:
        ...
        defaultSphericalHarmonicsFile (Optional[str], optional): The path for the
            default location of the spherical harmonics of the body. Defaults to None.
    """
    ...
    radiusRatio: float = 1
    defaultSphericalHarmonicsFile: Optional[str] = None
...
BODY_DATA = {
    ...
    "earth": BodyData(
        ...
        defaultSphericalHarmonicsFile="%BSK_PATH%/supportData/LocalGravData/GGM03S.txt",
    ),
    "moon": BodyData(
        identifier="moon",
    ...
    "mars": BodyData(
        ...
        defaultSphericalHarmonicsFile="%BSK_PATH%/supportData/LocalGravData/GGM2BData.txt",
    ),
...
class gravBodyFactory:
    ...
    def createBody(
        ...
        # Store this in the Python object so that it can be retrieved in
        # useSphericalHarmonicsGravityModel
        object.__setattr__(
            body,
            "_defaultSphericalHarmonicsFile",
            bodyData.defaultSphericalHarmonicsFile,
        )
        return body
    ...
    def createSpiceInterface(
        ...
        path: str,
        time: str,
        spiceKernalFileNames: Iterable[str] = [
            "de430.bsp",
            "naif0012.tls",
            "de-403-masses.tpc",
            "pck00010.tpc",
        ...
        Args:
            ...
            spiceKernalFileNames (Iterable[str], optional): A list of spice kernel file
    ...
    def createSpiceInterface(
        ...
        self.spiceKernelFileNames.extend(spiceKernalFileNames)
