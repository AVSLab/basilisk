...
class SimBaseClass:
    ...
    def ShowExecutionOrder(self):
        ...
        for processData in self.TotalSim.processList:
            print(
                f"{processColor}Process Name: {endColor}"
                + processData.processName
                + " , "
                + processColor
                + "priority: "
                + endColor
                + str(processData.processPriority)
            )
            for task in processData.processTasks:
                print(
                    f"{taskColor}Task Name: {endColor}"
                    ...
                    + "TaskPeriod: "
                    + endColor
                    + str(task.TaskPtr.TaskPeriod / 1.0e9)
                    + "s"
                )
                for module in task.TaskPtr.TaskModels:
                    print(
                        ...
                        + "ModuleTag: "
                        + endColor
                        + module.ModelPtr.ModelTag
                        + ", "
                        + moduleColor
                        + "priority: "
                        + endColor
                        + str(module.CurrentModelPriority)
                    )
            print("")
