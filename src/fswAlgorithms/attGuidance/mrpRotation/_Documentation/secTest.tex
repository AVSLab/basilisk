...
\begin{table}[htbp]
	...
	\begin{tabular}{ c | c } % Column formatting, 
		...
		\hline
		{\tt attRefOutMsgName.sigma\_RN}        & \input{AutoTex/toleranceValue}	   \\ 
		{\tt attRefOutMsgName.omega\_RN\_N}        & \input{AutoTex/toleranceValue}	   \\ 
		{\tt attRefOutMsgName.domega\_RN\_N}        & \input{AutoTex/toleranceValue}	   \\ 
		{\tt attitudeOutMsgName.state}        & \input{AutoTex/toleranceValue}	   \\ 
		{\tt attitudeOutMsgName.rate}        & \input{AutoTex/toleranceValue}	   \\ 
		\hline\hline
	\end{tabular}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{c | c  } % Column formatting, 
		...
		\hline
	   1	   			& \input{AutoTex/passFailFalseFalseFalse} \\ 
	   2	   			& \input{AutoTex/passFailTrueFalseFalse} \\ 
	   3	   			& \input{AutoTex/passFailFalseTrueFalse} \\ 
	   4	   			& \input{AutoTex/passFailFalseFalseTrue} \\ 
	   5	   			& \input{AutoTex/passFailTrueFalseTrue} \\ 
	   \hline\hline
	\end{tabular}
\end{table}
