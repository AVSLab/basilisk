 ...
 * @brief This module is intended to be the last module in the guidance module chain.  It's input is the reference motion message generated by a prior module.  It's output is at the guidance attitude tracking errors relative to a moving reference frame.  This module applies the body to corrected body attitude correction. The module [PDF Description](AVS-Sim-attTrackingError-2016-01-15.pdf) contains further information on this module's function, how to run it, as well as testing.
 * @{
 */
