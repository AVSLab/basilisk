...
{\bfseries Note:}. To \TeX\ this document you must run {\tt pytest} first.  This documents includes content that is auto-generated in the Python unit test and stored in a local folder called {\tt AutoTeX}.  
\vskip 2em
