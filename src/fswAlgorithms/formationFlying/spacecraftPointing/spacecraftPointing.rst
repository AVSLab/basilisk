...
.. bsk-module-io:: spacecraftPointing
    :caption: Module I/O Messages

    input chiefPositionInMsg NavTransMsgPayload
        primary position input message
    input deputyPositionInMsg NavTransMsgPayload
        secondary position input message
    output attReferenceOutMsg AttRefMsgPayload
