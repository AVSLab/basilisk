...
typedef struct {
    ...
    double windowDeg_apses;  // [deg], half-width of the thrust windows about apogee and perigee
    double windowDeg_nodes; // [deg], half-width of the thrust windows about the ascending and descending nodes
    
    int enableApsesWindows;
    int enableNodeWindows;

    BSKLogger *bskLogger;       
} alMeanOEFeedbackConfig;
