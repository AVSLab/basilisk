...
\begin{table}[htbp]
	...
	\begin{tabular}{ c | c } % Column formatting,
		...
		\hline
		{\tt r\_BdyZero\_N}        & \input{AutoTeX/tolerancePosValue} m	   \\
		{\tt v\_BdyZero\_N}        & \input{AutoTeX/toleranceVelValue} m/s   \\
		\hline\hline
	\end{tabular}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{c | c  } % Column formatting,
		...
		\hline
	   1	   			& \input{AutoTeX/passFailFalse} \\
	   2	   			& \input{AutoTeX/passFailTrue} \\
	   \hline\hline
	\end{tabular}
\end{table}
