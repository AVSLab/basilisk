...
\newcommand{\ModuleName}{ephemNavConverter}
\newcommand{\subject}{Navigation Ephemeris Message Converter}
\newcommand{\status}{Draft}
\newcommand{\preparer}{H. Schaub}
\newcommand{\summary}{Converter that takes an ephemeris output message and converts it over to a translational   state estimate message.}
...
\hline
1.0 & Initial Release & H. Schaub & 2019-03-26\\
\hline
