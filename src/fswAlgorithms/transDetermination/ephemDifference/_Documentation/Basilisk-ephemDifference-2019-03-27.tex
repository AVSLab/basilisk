...
\newcommand{\ModuleName}{ephemDifference}
\newcommand{\subject}{Ephemeris Difference Module}
\newcommand{\status}{First Release}
\newcommand{\preparer}{H. Schaub}
\newcommand{\summary}{This module reads in the position and velocity of multiple orbital bodies and outputs position and velocity of each body relative to a single other orbital body position and velocity.}
...
\hline
1.0 & Initial Release & H. Schaub & 2019-03-27\\
\hline
