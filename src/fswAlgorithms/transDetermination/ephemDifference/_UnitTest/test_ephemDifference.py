...
def ephemDifferenceTestFunction(ephBdyCount):
    ...
    functions = [
        astroFunctions.Mars_RV,
        astroFunctions.Jupiter_RV,
        astroFunctions.Saturn_RV,
    ]
    ...
    if ephBdyCount == 3:
        trueRVector = [
            [69313607.6209608, -75620898.04028425, -5443274.17030424],
            [-5.33462105e08, -7.56888610e08, 1.17556184e07],
            [9.94135029e07, -1.54721593e09, 1.65081472e07],
        ]

        trueVVector = [
            [15.04232523, -1.13359121, 0.47668898],
