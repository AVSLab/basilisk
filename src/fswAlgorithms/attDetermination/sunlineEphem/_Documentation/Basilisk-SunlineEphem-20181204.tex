...
\newcommand{\ModuleName}{sunlineEphem}
\newcommand{\subject}{Sunline Ephemeris Heading}
\newcommand{\status}{Initial Document}
\newcommand{\preparer}{J. Martin}
\newcommand{\summary}{Module to compute an ephemeris-based sunline heading}
...
\hline
1.0 & Initial Version & J. Martin & 20181203\\
1.1 & Small documentation tweaks & H. Schaub & 2019-04-24\\
\hline
