...
\newcommand{\subject}{CSS Comml}
\newcommand{\status}{Initial Version}
\newcommand{\preparer}{J. Martin}
\newcommand{\summary}{The CSS Sensor Data module is responsible for correcting course sun sensor data using a Chebyshev polynomial fit. }
