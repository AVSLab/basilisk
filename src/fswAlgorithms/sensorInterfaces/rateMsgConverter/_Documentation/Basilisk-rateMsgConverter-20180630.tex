...
\newcommand{\ModuleName}{rateMsgConverter}
\newcommand{\subject}{Module to convert the rate message between two message formats}
\newcommand{\status}{1st release}
\newcommand{\preparer}{H. Schaub}
\newcommand{\summary}{This module reads in a message of type {\tt IMUSensorBodyFswMsg}, extracts the rate vector, and returns it in an output message of type {\tt NavAttIntMsg}.  The remainder of the output message is zeroed.  }
...
\hline
1.0 & First release & H. Schaub & June 30, 2018\\
\hline
