...
@pytest.mark.parametrize(
    "image, blur, maxCircles, minDist, minRad, cannyLow, cannyHigh, dp, saveImage",
    [
...
def test_module(
    ...
    [testResults, testMessage] = houghCirclesTest(
        show_plots,
        image,
        blur,
        maxCircles,
...
def houghCirclesTest(
    ...
    if image == "moons.png":
        circles = [
            (205, 155, 48.900001525878906),
            (590, 313, 46.29999923706055),
            (590, 165, 46.29999923706055),
            (400, 313, 43.79999923706055),
            (400, 151.5, 45),
            (210, 313, 45),
        ]
