...
\newcommand{\summary}{This module either reads in a message of type {\tt CameraImageMsg}, or a filename for an image. It then uses the OpenCV HoughCircles method to extract circles. It then writes these messages in a message of type {\tt OpNavCirclesMsg}. }
