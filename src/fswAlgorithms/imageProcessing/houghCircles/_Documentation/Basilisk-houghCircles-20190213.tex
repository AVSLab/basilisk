...
\newcommand{\ModuleName}{houghCirlces}
\newcommand{\subject}{Module to find circles in an image}
\newcommand{\status}{1st Draft}
\newcommand{\preparer}{T. Teil}
\newcommand{\summary}{This module either reads in a message of type {\tt CameraImageMsg}, or a filename for an image. It then uses the OpenCV HoughCircles method to extract circles. It then writes these messages in a message of type {\tt CirclesOpNavMsg}. }
