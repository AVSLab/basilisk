...
/*! This method transforms pixel, line, and diameter data into heading data for orbit determination or heading
 determination.
 ...
 */
void
SelfInit_horizonOpNav(HorizonOpNavData* configData, int64_t moduleID)
{
 ...
 */
void
Reset_horizonOpNav(HorizonOpNavData* configData, uint64_t callTime, int64_t moduleID)
{
...
/*! This method reads in the camera and circle messages and extracts navigation data from them. It outputs the heading
 (norm and direction) to the celestial body identified in the inertial frame. It provides the heading to the most robust
 circle identified by the image processing algorithm.
 ...
 */
void
Update_horizonOpNav(HorizonOpNavData* configData, uint64_t callTime, int64_t moduleID)
{
 ...
 */
void
QRDecomp(double* inMat, int32_t nRow, double* Q, double* R)
{
    int32_t i, j;
 ...
 */
void
BackSub(double* R, double* inVec, int32_t nRow, double* n)
{
    int32_t i, j;
    double sum;
