...
\newcommand{\summary}{This module either reads in a message of type {\tt CameraImageMsgPayload}, or a filename for an image. It then uses the OpenCV's Canny method to extract the limb points. It then writes these messages in a message of type {\tt OpNavLimbMsgPayload}. }
