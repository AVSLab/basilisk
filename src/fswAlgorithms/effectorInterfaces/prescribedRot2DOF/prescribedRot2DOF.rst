...
.. bsk-module-io:: prescribedRot2DOF
    :caption: Module I/O Messages

    input spinningBodyRef1InMsg HingedRigidBodyMsgPayload
        Input msg with the scalar spinning body rotational reference states for the first rotation
    input spinningBodyRef2InMsg HingedRigidBodyMsgPayload
        Input msg with the scalar spinning body rotational reference states for the second rotation
    output prescribedMotionOutMsg PrescribedRotationMsgPayload
