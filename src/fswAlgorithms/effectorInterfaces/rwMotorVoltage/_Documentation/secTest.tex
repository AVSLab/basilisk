...
\subsection{Test 2}
This test repeats the values of test 1, except that the RW motor torque input vector is set to \input{AutoTex/usTrueFalseFalse.tex} Nm.  This should saturate the first and last RW voltage output, which is seen in Table~\ref{tbl:testTrueFalseFalse}. 
...
\begin{table}[H]
	...
	\begin{tabular}{c | c  } % Column formatting, 
	   ...
	   1	   			& \input{AutoTex/passFailOne} \\ \hline
		2	   			& \input{AutoTex/passFailTwo} \\ \hline
		3	   			& \input{AutoTex/passFailThree} \\ \hline
		4	   			& \input{AutoTex/passFailFour} \\ \hline
	\end{tabular}
\end{table}
