...
def test_hingedRigidBodyPIDMotor(
    show_plots, thetaR, thetaDotR, theta, thetaDot, K, P, I, accuracy
):
    r"""
    ...
    **Description of Variables Being Tested**
    ...
    [testResults, testMessage] = hingedRigidBodyPIDMotorTestFunction(
        show_plots, thetaR, thetaDotR, theta, thetaDot, K, P, I, accuracy
    )
    assert testResults < 1, testMessage


def hingedRigidBodyPIDMotorTestFunction(
    show_plots, thetaR, thetaDotR, theta, thetaDot, K, P, I, accuracy
):
    ...
    if not unitTestSupport.isDoubleEqual(dataLog.motorTorque[0][0], T, accuracy):
        ...
        testMessages.append(
            "FAILED: "
            + motor.ModelTag
            + " module failed unit test for thetaR = {}, thetaDotR  = {}, theta = {}, thetaDot = {}, K = {}, P = {} \n".format(
                thetaR, thetaDotR, theta, thetaDot, K, P
            )
        )
