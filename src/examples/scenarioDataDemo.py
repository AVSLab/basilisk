...
:ref:`onboardDataManagement` group of modules, which represent Basilisk's low-fidelity data system modeling functionality. Specifically,
:ref:`onboardDataManagement` modules are intended to provide three major features:
...
The onboardDataManagement subsystem consists of two kinds of Basilisk simModules: :ref:`dataStorageUnitBase` (which is used to represent
...
One version of this process is demonstrated here using methods that are described in other scenarios. Three onboardDataManagement modules are created:
