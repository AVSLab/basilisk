...
onboardDataManagement group of modules, which represent Basilisk's low-fidelity data system modeling functionality. Specifically,
onboardDataManagement modules are intended to provide three major features:
