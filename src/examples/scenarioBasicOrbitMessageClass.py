...
def run(show_plots, orbitCase, useSphericalHarmonics, planetCase):
    ...
    mu = earth.mu
    planet = earth  # I don't want to much around changes the post-processing refs

    earthEphemInMessage = message.SpicePlanetStateSimMsgClass()
    earth.readInputMsg = earthEphemInMessage.addSubscriber()
