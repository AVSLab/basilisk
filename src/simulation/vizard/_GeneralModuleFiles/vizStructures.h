...
//@endcond
{
    ...
    std::string truePathPrimaryBody = "";                 //!< String of the celestial body name to plot the true path trajectory line[s] against, empty string to use the spacecraft's primary body
