...
def test_simpleAntenna(antennaState, env_type, T_AmbientSet, useHaslamMap, T_sky_true, eclipseValue, sigma_AB, scPosUnit, eclipseMsgLinked, ACCURACY):
    ...
    **Description of Variables Being Tested**
    ...
    """
    [testResults, testMessage, _] = simpleAntennaTestFunction(antennaState, env_type, T_AmbientSet, useHaslamMap, T_sky_true, eclipseValue, sigma_AB, scPosUnit, eclipseMsgLinked, ACCURACY)
...
def simpleAntennaTestFunction(antennaState, env_type, T_AmbientSet, useHaslamMap, T_sky_true, eclipseValue, sigma_AB, scPosUnit, eclipseMsgLinked, ACCURACY):
    """Test method"""
    testFailCount = 0
    testMessages = []
