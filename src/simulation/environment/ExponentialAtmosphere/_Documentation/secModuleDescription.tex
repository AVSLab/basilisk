...
By invoking the atmosphere module, the default values are set such that this basic exponential atmosphere model returns zero for all inputs. Intial values can be specified using the \verb{setSimPlanetEnvironment.exponentialAtmosphere} macro.
