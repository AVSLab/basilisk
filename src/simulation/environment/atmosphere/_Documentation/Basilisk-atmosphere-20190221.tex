...
\newcommand{\ModuleName}{Atmosphere}
\newcommand{\subject}{Atmosphere}
\newcommand{\status}{Released}
\newcommand{\preparer}{A. Harris}
\newcommand{\summary}{The {\tt Atmosphere} class used to calculate temperature / density above a body using multiple models.
