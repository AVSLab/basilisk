...
\begin{table}[H]
	...
	\begin{tabular}{c  | c  | c} % Column formatting, 
		...
		\hline
		LPO & False &  \input{AutoTeX/unitTestPassFailLPOFalse} \\ 
		LTO & False &  \input{AutoTeX/unitTestPassFailLTOFalse} \\ 
		LPO & True &  \input{AutoTeX/unitTestPassFailLPOTrue} \\ 
		LTO & True &  \input{AutoTeX/unitTestPassFailLTOTrue} \\ 
		\hline
		\hline
	\end{tabular}
\end{table}
