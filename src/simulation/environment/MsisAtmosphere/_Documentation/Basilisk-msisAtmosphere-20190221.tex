...
\newcommand{\ModuleName}{MsisAtmosphere}
\newcommand{\subject}{MsisAtmosphere}
\newcommand{\status}{First Review}
\newcommand{\preparer}{A. Harris}
\newcommand{\summary}{The {\tt MsisAtmosphere} class used to calculate temperature, density, and neutral species for a spacecraft in Earth orbit up to 1000km using the NRLMSISE-00 neutral density model.  }
