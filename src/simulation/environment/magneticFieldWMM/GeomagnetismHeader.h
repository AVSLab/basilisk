...
#define VERSIONDATE_LARGE "$Date: 2019-12-10 10:40:43 -0700 (Tue, 10 Dec 2019) $"
    ...
    typedef struct
    {
        ...
        double* Main_Field_Coeff_G; /*!< C - Gauss coefficients of main geomagnetic model (nT) Index is (n * (n + 1) / 2
                                       + m) */
    ...
    void MAG_BaseErrors(double DeclCoef,
                        double DeclBaseline,
                        double InclOffset,
                        double FOffset,
                        double Multiplier,
    ...
    void MAG_CartesianToGeodetic(MAGtype_Ellipsoid Ellip,
                                 double x,
                                 double y,
                                 double z,
                                 MAGtype_CoordGeodetic* CoordGeodetic);
    ...
    void MAG_GradY(MAGtype_Ellipsoid Ellip,
                   MAGtype_CoordSpherical CoordSpherical,
                   MAGtype_CoordGeodetic CoordGeodetic,
                   MAGtype_MagneticModel* TimedMagneticModel,
                   MAGtype_GeoMagneticElements GeoMagneticElements,
    ...
    int MAG_GetAltitude(char* Query_String,
                        MAGtype_Geoid* Geoid,
