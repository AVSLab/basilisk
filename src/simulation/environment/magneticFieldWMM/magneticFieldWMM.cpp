 ...
 */
void MagneticFieldWMM::customReset(uint64_t CurrentClock [[maybe_unused]])
{
    if (this->magneticModel != nullptr) {
 ...
 */
void MagneticFieldWMM::decimalYear2Gregorian(double fractionalYear [[maybe_unused]], struct tm *gregorian)
{
