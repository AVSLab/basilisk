 ...
 */
void
MagneticFieldWMM::customReset(uint64_t CurrentClock)
{
    if (this->magneticModel != nullptr) {
 ...
 */
void
MagneticFieldWMM::customSetEpochFromVariable()
{
 ...
 */
void
MagneticFieldWMM::decimalYear2Gregorian(double fractionalYear, struct tm* gregorian)
{
 ...
 */
double
MagneticFieldWMM::gregorian2DecimalYear(double currentTime)
{
 ...
 */
void
MagneticFieldWMM::evaluateMagneticFieldModel(MagneticFieldMsgPayload* msg, double currentTime)
{
 ...
 */
void
MagneticFieldWMM::cleanupEarthMagFieldModel()
{
...
void
MagneticFieldWMM::computeWmmField(double decimalYear, MAGtype_CoordSpherical coordSpherical, double B_M[3])
{
    ...
    MAG_ComputeSphericalHarmonicVariables(
      this->ellip, coordSpherical, this->timedMagneticModel->nMax, this->SphVariables);
    ...
    MAG_Summation(
      this->LegendreFunction, this->timedMagneticModel, *this->SphVariables, coordSpherical, &MagneticResultsSph);
