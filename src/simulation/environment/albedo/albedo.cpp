 ...
 */
void
Albedo::addInstrumentConfig(instConfig_t configMsg)
{
 ...
 */
void
Albedo::addInstrumentConfig(double fov, Eigen::Vector3d nHat_B, Eigen::Vector3d r_IB_B)
{
    // add a albedo output message for this instrument
    Message<AlbedoMsgPayload>* msg;
    msg = new Message<AlbedoMsgPayload>;
 ...
 */
void
Albedo::addPlanetandAlbedoAverageModel(Message<SpicePlanetStateMsgPayload>* planetSpiceMsg)
{
 ...
 */
void
Albedo::addPlanetandAlbedoDataModel(Message<SpicePlanetStateMsgPayload>* planetSpiceMsg,
                                    std::string dataPath,
                                    std::string fileName)
{
 ...
 */
void
Albedo::UpdateState(uint64_t CurrentSimNanos)
{
    this->readMessages();
    this->albOutData.clear();
 ...
 */
void
Albedo::Reset(uint64_t CurrentSimNanos)
{
 ...
 */
void
Albedo::writeMessages(uint64_t CurrentSimNanos)
{
 ...
 */
void
Albedo::getPlanetRadius(std::string planetSpiceName)
{
 ...
 */
double
Albedo::getAlbedoAverage(std::string planetSpiceName)
{
    double ALB_avg;
    if (planetSpiceName == "mercury") {
        ALB_avg = 0.119;
 ...
 */
void
Albedo::evaluateAlbedoModel(int idx)
{
    this->readFile = false;
 ...
 */
void
Albedo::computeAlbedo(int idx, int instIdx, SpicePlanetStateMsgPayload planetMsg, bool albArray, double outData[])
{
 ...
 */
double
Albedo::computeEclipseAtdA(double Rplanet, Eigen::Vector3d r_dAP_N, Eigen::Vector3d r_SP_N)
{
