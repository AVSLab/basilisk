...
-------------------------------
The following table lists all module input and output messages.  The user sets
module message connections from Python.  The message type links to the message
structure definition, while the description explains its use.


.. bsk-module-io:: planetEphemeris
    :caption: Module I/O Messages

    output planetOutMsgs SpicePlanetStateMsgPayload
