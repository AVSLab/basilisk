 ...
 */
void
PowerStorageBase::addPowerNodeToModel(Message<PowerNodeUsageMsgPayload>* tmpNodeMsg)
{
 ...
 */
void
PowerStorageBase::Reset(uint64_t CurrentSimNanos)
{
    this->previousTime = 0;
 ...
 */
void
PowerStorageBase::writeMessages(uint64_t CurrentClock)
{
 ...
 */
void
PowerStorageBase::integratePowerStatus(double currentTime)
{
 ...
 */
void
PowerStorageBase::UpdateState(uint64_t currentSimNanos)
{
 ...
 */
void
PowerStorageBase::customReset(uint64_t CurrentClock)
{
    return;
}
 ...
 */
void
PowerStorageBase::customWriteMessages(uint64_t CurrentClock)
{
    return;
}
 ...
 */
bool
PowerStorageBase::customReadMessages()
{
    return true;
}
