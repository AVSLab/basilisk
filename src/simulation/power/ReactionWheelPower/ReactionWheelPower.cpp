 ...
 */
void
ReactionWheelPower::customReset(uint64_t CurrentSimNanos)
{
    if (this->elecToMechEfficiency <= 0.0) {
        bskLogger.bskLog(BSK_ERROR,
                         "PowerRW: elecToMechEfficiency is %f, must a strictly positive value.",
 ...
 */
bool
ReactionWheelPower::customReadMessages()
{
 ...
 */
void
ReactionWheelPower::evaluatePowerModel(PowerNodeUsageMsgPayload* powerUsageSimMsg)
{
    double rwPowerNeed;
    double wheelPower;
