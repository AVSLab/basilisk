 ...
 */
void
SimpleSolarPanel::customReset(uint64_t CurrentClock)
{
...
bool
SimpleSolarPanel::customReadMessages()
{
 ...
 */
void
SimpleSolarPanel::setPanelParameters(Eigen::Vector3d nHat_B, double panelArea, double panelEfficiency)
{
    this->nHat_B = nHat_B;
...
/*! This method computes the spacecraft-sun vector, the solar panel's projected area, and the sunDistanceFactor based on
   the magnitude of the spacecraft sun vector.

 */
void
SimpleSolarPanel::computeSunData()
{
...
/*! This method computes the power generated by the solar panel and stores it in a PowerNodeUsageMsgPayload. This is
evaluated in two steps:
1. Compute the amount of power available at the spacecraft position using the SOLAR_FLUX_EARTH macro, distance factor,
and eclipse shadow factor;
2. Compute how much of that power is captured and converted to power using the projectedArea and panelEfficiency
attributes.

 */
void
SimpleSolarPanel::evaluatePowerModel(PowerNodeUsageMsgPayload* powerUsageSimMsg)
{
