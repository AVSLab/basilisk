...
\newcommand{\subject}{Reaction Wheel Voltage to Torque Converter}
\newcommand{\status}{Tested}
\newcommand{\preparer}{S. Carnahan}
\newcommand{\summary}{The RW Voltage Interface converts commanded voltages to generated reaction wheel torques via a gain factor (perfect conversion), a scale factor (error in conversion), and bias (constant offset).}
...
{\renewcommand{\arraystretch}{2}
	...
	\begin{longtable}{|p{0.5in}|p{3.5in}|p{1.07in}|p{0.9in}|}
		...
		\hline
		1.0 & First draft & S. Carnahan & 20180316 \\
		\hline
