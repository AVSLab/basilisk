...
\newcommand{\summary}{The RW Voltage Interface converts commanded voltages to generated reaction wheel torques via a gain factor (perfect conversion), a scale factor (error in conversion), and bias.}
