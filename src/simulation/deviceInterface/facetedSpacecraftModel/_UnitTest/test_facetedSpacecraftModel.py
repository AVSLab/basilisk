...
def test_facetedSpacecraftModel(show_plots,
    ...
    **Description of Variables Being Tested**
    ...
    articulated_facet_angle_message_data.thetaDot = 0.0  # [rad/s]
    ...
    sim_time_2 = macros.sec2nano(3.0)  # [ns]
    ...
    articulated_facet_1_data_to_check = [
        ...
        (facet_nHat_B_list_sim[0][3:6], facet_nHat_B_list_truth[1]),
        (facet_rotHat_B_list_sim[0][3:6], facet_rotHat_B_list_truth[1])
    ]
