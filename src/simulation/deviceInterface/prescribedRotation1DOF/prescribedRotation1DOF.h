...
private:
    /* Methods for computing the required rotation parameters */
    ...
    double thetaRef;                                                       //!< [rad] Spinning body reference angle for the orientation of frame F relative to frame M about rotHat_M
