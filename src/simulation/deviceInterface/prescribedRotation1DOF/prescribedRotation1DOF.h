...
class PrescribedRotation1DOF : public SysModel
{
  public:
    ...
    ReadFunctor<HingedRigidBodyMsgPayload>
      spinningBodyInMsg; //!< Input msg for the spinning body reference angle and angle rate
    ...
    PrescribedRotationMsg_C
      prescribedRotationOutMsgC = {}; //!< C-wrapped output msg for the spinning body prescribed rotational states

    BSKLogger* bskLogger; //!< BSK Logging

  private:
    /* Methods for computing the required rotational parameters */
    void computeRotationParameters(); //!< Intermediate method to group the calculation of rotation parameters into a
                                      //!< single method
    ...
    void computeSmoothedBangBangParameters();         //!< Method for computing the required parameters for the smoothed
                                                      //!< bang-bang profiler option
    void computeSmoothedBangCoastBangParameters();    //!< Method for computing the required parameters for the smoothed
                                                      //!< bang-coast-bang profiler option
    ...
    void computeCurrentState(double time); //!< Intermediate method used to group the calculation of the current
                                           //!< rotational states into a single method
    ...
    void computeSecondBangSegment(
      double time); //!< Method for computing the second bang segment scalar rotational states
    void computeFirstSmoothedSegment(double time);  //!< Method for computing the first smoothing segment scalar
                                                    //!< rotational states for the smoothed profiler options
    ...
    void computeFourthSmoothedSegment(double time); //!< Method for computing the fourth smoothing segment scalar
                                                    //!< rotational states for the smoothed bang-coast-bang option
    ...
    Eigen::Vector3d computeSigma_PM(); //!< Method for computing the current spinning body MRP attitude relative to the
                                       //!< mount frame: sigma_PM
