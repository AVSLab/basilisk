...
One output message of an individual CSS unit creates a message containing the simulated CSS sensor.  The second output message is of type {\tt CSSConfigLogSimMsg} that logs the CSS configuration states.  The output message name {\tt cssConfigLogMsgName} will default to
\begin{verbatim}
	this->ModelTag + "_config_log"
\end{verbatim}
unless the user specifies a custom name.
