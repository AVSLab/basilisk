...
\newcommand{\ModuleName}{Magnetometer}
\newcommand{\subject}{Magnetic Field Measurements}
\newcommand{\status}{Tested}
\newcommand{\preparer}{D. Cilden-Guler}
\newcommand{\summary}{The Basilisk Three-Axis Magnetometer (TAM) module is responsible for producing magnetic field measurements in sensor frame from the magnetic field model. The TAM module applies Gauss-Markov process noise to the true
magnetic field values. A unit test has been written which validates outputs of the TAM.}
