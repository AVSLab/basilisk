...
@pytest.mark.parametrize(
    ...
    [
        ...
        (False, 1.0, np.pi / 2., 0.0, 1.0, 0.0, 0.125, 0.0, 1.0, -10., 10., 5e-2, "deviation", -5, 1.),
        # low tolerance for standard deviation comparison
        ...
        (False, 1.0, np.pi / 2., 0.0, 2.0, 0.0, 0.125, 0.0, 1.0, -10., 10., 5e-2, "combined", -6, 1.),
