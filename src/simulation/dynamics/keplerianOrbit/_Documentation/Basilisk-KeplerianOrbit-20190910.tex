...
\newcommand{\ModuleName}{keplerianOrbit}
\newcommand{\subject}{Keplerian Orbit C++ model}
\newcommand{\status}{Tested}
\newcommand{\preparer}{S. Carnahan}
\newcommand{\summary}{The Keplerian orbit class is an object oriented keplerian orbit. Given a planet and orbital elements it can provide a host of outputs including orbital period and position and velocity.}
