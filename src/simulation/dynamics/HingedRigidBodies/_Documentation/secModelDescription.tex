...
The panel provides an output message {\tt hingedRigidBodyConfigLogOutMsgName} of type {\tt SCPlusStatesSimMsg}.  This message contains the panel frame $S_i$ position and attitude states.  As this is a regular spacecraft state message, this output message can be piped to other modules such as the coarse sun sensor or solar panel power module spacecraft state input message.  This allows the CSS or solar power evaluation to be performed relative to the time-varying panel configuration.
