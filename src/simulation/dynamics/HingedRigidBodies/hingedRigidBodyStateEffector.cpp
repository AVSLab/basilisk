 ...
 */
void
HingedRigidBodyStateEffector::writeOutputStateMessages(uint64_t CurrentClock)
{
...
void
HingedRigidBodyStateEffector::prependSpacecraftNameToStates()
{
...
void
HingedRigidBodyStateEffector::linkInStates(DynParamManager& statesIn)
{
...
void
HingedRigidBodyStateEffector::registerStates(DynParamManager& states)
{
...
/*! This method allows the HRB state effector to provide its contributions to the mass props and mass prop rates of the
 spacecraft */
void
HingedRigidBodyStateEffector::updateEffectorMassProps(double integTime)
{
...
/*! This method allows the HRB state effector to give its contributions to the matrices needed for the back-sub
 method */
void
HingedRigidBodyStateEffector::updateContributions(double integTime,
...
void
HingedRigidBodyStateEffector::computeDerivatives(double integTime,
...
void
HingedRigidBodyStateEffector::updateEnergyMomContributions(double integTime,
 ...
 */
void
HingedRigidBodyStateEffector::UpdateState(uint64_t CurrentSimNanos)
{
...
void
HingedRigidBodyStateEffector::calcForceTorqueOnBody(double integTime, Eigen::Vector3d omega_BN_B)
{
 ...
 */
void
HingedRigidBodyStateEffector::computePanelInertialStates()
{
    // inertial attitude
    Eigen::MRPd sigmaBN;
