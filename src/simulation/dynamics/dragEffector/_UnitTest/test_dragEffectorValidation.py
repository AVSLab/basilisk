...
from Basilisk.simulation import dragDynamicEffector, spacecraft
from Basilisk.utilities import SimulationBaseClass, macros


@pytest.mark.parametrize("validationPath", ["attachment", "reset"])
def test_dragEffector_validation(validationPath):
    """Attachment initialization and direct Reset() must reject a missing density input."""
