 ...
 */
void
ExtForceTorque::Reset(uint64_t CurrentSimNanos)
{
...
void
ExtForceTorque::linkInStates(DynParamManager& statesIn)
{
}
 ...
 */
void
ExtForceTorque::writeOutputMessages(uint64_t currentClock)
{
}
 ...
 */
void
ExtForceTorque::readInputMessages()
{
 ...
 */
void
ExtForceTorque::computeForceTorque(double integTime, double timeStep)
{
...
void
ExtForceTorque::UpdateState(uint64_t CurrentSimNanos)
{
