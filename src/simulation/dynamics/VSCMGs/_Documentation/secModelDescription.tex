...
The key equations are highlighted below and the full deriviation can be found in \cite{alcorn2017}.
...
\label{eq:vscmgTranslationSimpleBS_BACKSUBAPP}
\end{equation*}
...
\end{gather}
This concludes the derivation of the back-substitution of imbalanced VSCMGs. 
