...
private:
    ...
    Eigen::MatrixXd* r_Sc1N_N;           //!< [m] position vector of lower spinning body center of mass Sc1 relative to the inertial frame origin N
    Eigen::MatrixXd* r_Sc2N_N;           //!< [m] position vector of upper spinning body center of mass Sc2 relative to the inertial frame origin N
    Eigen::MatrixXd* v_Sc1N_N;           //!< [m/s] inertial velocity vector of Sc1 relative to inertial frame
    Eigen::MatrixXd* v_Sc2N_N;           //!< [m/s] inertial velocity vector of Sc2 relative to inertial frame
