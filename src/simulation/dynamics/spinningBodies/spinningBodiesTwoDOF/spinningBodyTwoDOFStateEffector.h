...
class SpinningBodyTwoDOFStateEffector final: public StateEffector, public SysModel {
public:
...
private:
    std::vector<int> dynEffectorSegments; //!< Body index for each dynamic attachment.
...
public:
    ...
    SpinningBodyTwoDOFStateEffector();      //!< Constructor
