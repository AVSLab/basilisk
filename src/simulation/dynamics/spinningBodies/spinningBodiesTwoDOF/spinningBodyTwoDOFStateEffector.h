  ...
  , public SysModel
{
  public:
    ...
    Eigen::Vector3d r_Sc1S1_S1{ 0.0, 0.0, 0.0 }; //!< [m] vector pointing from lower spinning frame S1 origin to point
                                                 //!< Sc1 (center of mass of the lower spinner) in S1 frame components
    Eigen::Vector3d r_Sc2S2_S2{ 0.0, 0.0, 0.0 }; //!< [m] vector pointing from upper spinning frame S2 origin to point
                                                 //!< Sc2 (center of mass of the upper spinner) in S2 frame components
  ...
  private:
    ...
    Eigen::Matrix3d IPrimeS1PntSc1_B; //!< [kg-m^2] body frame time derivative of inertia of inertia of lower spinning
                                      //!< body about point Sc1 in B frame components
    Eigen::Matrix3d IPrimeS2PntSc2_B; //!< [kg-m^2] body frame time derivative of inertia of inertia of upper spinning
                                      //!< body about point Sc2 in B frame components

    // Spinning body properties
    Eigen::Vector3d r_Sc1N_N{
        0.0,
        0.0,
        0.0
    }; //!< [m] position vector of lower spinning body center of mass Sc1 relative to the inertial frame origin N
    Eigen::Vector3d r_Sc2N_N{
        0.0,
        0.0,
        0.0
