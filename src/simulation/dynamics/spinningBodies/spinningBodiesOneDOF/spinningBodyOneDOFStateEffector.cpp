...
void SpinningBodyOneDOFStateEffector::registerStates(DynParamManager& statesIn)
{
    ...
    this->thetaState = managerLocal
        ? statesIn.registerEffectorState(1, 1, this->getEffectorNameRequest(), "nameOfThetaState")
