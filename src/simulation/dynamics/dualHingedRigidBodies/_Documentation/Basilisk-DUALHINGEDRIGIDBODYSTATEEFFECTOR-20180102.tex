...
\newcommand{\ModuleName}{dualHingedRigidBodyStateEffector}
\newcommand{\subject}{Dual Hinged Rigid Body Dynamics Model}
%\newcommand{\status}{Initial Draft}
%\newcommand{\preparer}{C. Allard}
%\newcommand{\summary}{The dual hinged rigid body class is an instantiation of the state effector abstract class. The integrated test is validating the interaction between the hinged rigid body module and the rigid body hub that it is attached to.}
%
\begin{document}
...
\hline
1.0 & Initial Draft & C. Allard & 2018-01-02\\
\hline
1.1 & Added panel output messages & H. Schaub & 2020-10-13\\
\hline
\end{longtable}
}
