...
private:
    ...
    Eigen::Vector3d r_H2P_P;          //!< [m] vector pointing from primary body frame P origin to Hinge 2 location.  If a single spacecraft body is modeled than P is the same as B
