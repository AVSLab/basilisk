...
\begin{table}[htbp]
	...
	\begin{tabular}{| c | c | c | c |} % Column formatting, 
		...
		\hline
		(Particle 2) rhoInit  & (Particle 1) Initial $\rho$ & -0.025 & m \\
		\hline
		(Particle 2) rhoDotInit  & (Particle 1) Initial $\dot{\rho}$ & 0.0 & m/s \\
		\hline
		(Particle 3) rhoInit  & (Particle 1) Initial $\rho$ & -0.015 & m \\
		\hline
		(Particle 3) rhoDotInit  & (Particle 1) Initial $\dot{\rho}$ & 0.0 & m/s \\
		\hline
