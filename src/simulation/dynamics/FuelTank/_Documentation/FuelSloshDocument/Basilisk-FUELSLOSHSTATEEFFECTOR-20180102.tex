...
\newcommand{\summary}{The fuel slosh class is an instantiation of the state effector abstract class. The integrated test is validating the interaction between the fuel slosh module and the rigid body hub that it is attached to.}
