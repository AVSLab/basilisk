...
For compactness, define $q(\theta^*)=\sin^4{\theta^*}$, such that the variable component of the fuel center of mass is
\begin{equation}
	\left(\bm{r}_{Tc/B}-\bm{r}_{Tc'/B}\right)\cdot\bm{\hat{k}}_3
	= -\frac{\pi\,R_{\text{tank}}^4\,\rho_{\text{fuel}}}{4\,m_{\text{fuel}}}\,q.
\end{equation}
The required derivatives of $q$ are
\begin{equation}
	\dot{q}=4\sin^3{\theta^*}\cos{\theta^*}\dot{\theta^*},
\end{equation}
\begin{equation}
	\ddot{q}=4\left[\left(3\sin^2{\theta^*}\cos^2{\theta^*}-\sin^4{\theta^*}\right)\dot{\theta^*}^2
	+\sin^3{\theta^*}\cos{\theta^*}\ddot{\theta^*}\right].
\end{equation}
Thus, the fuel center-of-mass velocity and acceleration along $\bm{\hat{k}}_3$ are
\begin{equation}
	\bm{r}'_{Tc/B}\cdot\bm{\hat{k}}_3
	= -\frac{\pi\,R_{\text{tank}}^4\,\rho_{\text{fuel}}}{4}
	\left(\frac{\dot{q}}{m_{\text{fuel}}}
	-\frac{q\dot{m}_{\text{fuel}}}{m_{\text{fuel}}^2}\right),
\end{equation}
\begin{multline}
	\bm{r}''_{Tc/B}\cdot\bm{\hat{k}}_3
	= -\frac{\pi\,R_{\text{tank}}^4\,\rho_{\text{fuel}}}{4}
	\left(\frac{\ddot{q}}{m_{\text{fuel}}}
	-\frac{2\dot{q}\dot{m}_{\text{fuel}}}{m_{\text{fuel}}^2}
	-\frac{q\ddot{m}_{\text{fuel}}}{m_{\text{fuel}}^2}
	+\frac{2q\dot{m}_{\text{fuel}}^2}{m_{\text{fuel}}^3}\right).
\end{multline}
The implementation assumes a piecewise-constant mass flow during each dynamics evaluation, so $\ddot{m}_{\text{fuel}}=0$.
...
\begin{multline}
	...
	= \frac{2}{5}\pi\,\rho_{\text{fuel}}R^5_{\text{tank}}\left[\frac{2}{3}  + \frac{1}{4}\cos{\theta^*}\sin^4{\theta^*} -\frac{1}{12}\left(\cos{3\theta^*} - 9\cos{\theta^*}\right)\right]
\end{multline}
...
\end{multline}
\begin{multline}
	I'_{2\,2}	= I'_{1\,1}= \frac{2}{5}\pi\,\rho_{\text{fuel}}R^5_{\text{tank}} \, \dot{\theta^*}\left[ \frac{5}{4}\sin{\theta^*}\cos^4{\theta^*} -\frac{5}{4}\sin{\theta^*} -\frac{1}{8}\sin{3\theta^*} +\right.\\
