...
def test_tankModelConstantVolume(show_plots=False):
    ...
    true_r_TcT_T = [[1, 1, 1], [1, 1, 1], [1, 1, 1]]
    true_rPrime_TcT_T = [[0, 0, 0], [0, 0, 0], [0, 0, 0]]
    true_rPPrime_TcT_T = [[0, 0, 0], [0, 0, 0], [0, 0, 0]]
...
def test_tankModelEmptying(show_plots=False):
    ...
    true_r_TcT_T = [[1, 1, 1 - 5.0], [1, 1, 1], [1, 1, 1.0 - 15.0 / 8.0]]
    true_rPrime_TcT_T = [[0, 0, 0], [0, 0, 0], [0, 0, -3.0 / 8.0]]
    true_rPPrime_TcT_T = [[0, 0, 0], [0, 0, 0], [0, 0, -17.0 / 30.0]]
