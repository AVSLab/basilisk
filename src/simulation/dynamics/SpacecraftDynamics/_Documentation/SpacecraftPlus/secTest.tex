...
This test is located in \texttt{simulation/dynamics/spacecraftPlus/\_UnitTest/\newline
...
\begin{figure}[htbp]
	\centerline{
		\includegraphics[width=0.8\textwidth]{../AutoTeX/ChangeInOrbitalEnergyTranslationOnly}}
	\caption{Change in Orbital Energy Translation Only}
	\label{fig:ChangeInOrbitalEnergyTranslationOnly}
\end{figure}
\begin{figure}[htbp]
	\centerline{
		\includegraphics[width=0.8\textwidth]{../AutoTeX/ChangeInOrbitalAngularMomentumTranslationOnly}}
...
\begin{figure}[htbp]
	\centerline{
		\includegraphics[width=0.8\textwidth]{../AutoTeX/ChangeInRotationalEnergyRotationOnly}}
	\caption{Change in Rotational Energy Rotation Only}
	\label{fig:ChangeInRotationalEnergyRotationOnly}
\end{figure}
\begin{figure}[htbp]
	\centerline{
		\includegraphics[width=0.8\textwidth]{../AutoTeX/ChangeInRotationalAngularMomentumRotationOnly}}
	\caption{Change in Rotational Angular Momentum Rotation Only}
	\label{fig:ChangeInRotationalAngularMomentumRotationOnly}
\end{figure}
\begin{figure}[htbp]
	\centerline{
		\includegraphics[width=0.8\textwidth]{../AutoTeX/MRPs}}
	\caption{Attitude of Spacecraft in MRPs}
	\label{fig:MRPs}
\end{figure}
\begin{figure}[htbp]
	\centerline{
		\includegraphics[width=0.8\textwidth]{../AutoTeX/MRPSwitching}}
	\caption{MRP Switching}
	\label{fig:MRPSwitching}
\end{figure}
\begin{figure}[htbp]
	\centerline{
		\includegraphics[width=0.8\textwidth]{../AutoTeX/BasiliskVsBOECalcForRotation}}
...
\begin{figure}[htbp]
	\centerline{
		\includegraphics[width=0.8\textwidth]{../AutoTeX/ChangeInOrbitalEnergyTranslationAndRotation}}
	\caption{Change in Orbital Energy Translation And Rotation}
	\label{fig:ChangeInOrbitalEnergyTranslationAndRotation}
\end{figure}
\begin{figure}[htbp]
	\centerline{
		\includegraphics[width=0.8\textwidth]{../AutoTeX/ChangeInOrbitalAngularMomentumTranslationAndRotation}}
...
\begin{figure}[htbp]
	\centerline{
		\includegraphics[width=0.8\textwidth]{../AutoTeX/ChangeInRotationalEnergyTranslationAndRotation}}
	\caption{Change in Rotational Energy Translation And Rotation}
	\label{fig:ChangeInRotationalEnergyTranslationAndRotation}
\end{figure}
\begin{figure}[htbp]
	\centerline{
		\includegraphics[width=0.8\textwidth]{../AutoTeX/ChangeInRotationalAngularMomentumTranslationAndRotation}}
...
\begin{figure}[htbp]
	\centerline{
		\includegraphics[width=0.8\textwidth]{../AutoTeX/TranslationPositionBOE}}
	\caption{Translation Position BOE}
	\label{fig:TranslationPositionBOE}
\end{figure}
\begin{figure}[htbp]
	\centerline{
		\includegraphics[width=0.8\textwidth]{../AutoTeX/TranslationVelocityBOE}}
...
\begin{figure}[htbp]
	\centerline{
		\includegraphics[width=0.8\textwidth]{../AutoTeX/PointBVsPointCTranslation}}
	\caption{PointB Vs PointC Translation}
	\label{fig:PointBVsPointCTranslation}
\end{figure}
\begin{figure}[htbp]
	\centerline{
		\includegraphics[width=0.8\textwidth]{../AutoTeX/PointBVsPointCAttitude}}
