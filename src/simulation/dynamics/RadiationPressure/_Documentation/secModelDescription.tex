...
\begin{equation}
SF_{\mathrm{AU}} = 1361.0    \bigg[\frac{W}{m^2}\bigg]
\end{equation}
...
Solar eclipses are are detected by the basilisk eclipse module. The effects of the eclipse are calculated into a illumination factor, $F_{\mathrm{s}}$, which is applied to the output forces and torques.
\begin{equation}
