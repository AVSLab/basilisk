...
//@endcond
{
    ...
    double betaStatic = -1.0; //!< Stribeck friction coefficient; For stribeck friction to be activiated, user must
                              //!< change this variable to a positive non-zero number.
    ...
    bool frictionStribeck = 0;         //!< [-] Boolenian to determine if stribeck friction model is used or not, 0 is
                                       //!< non-stribeck, 1 is stribeck; Parameter is set internally.
