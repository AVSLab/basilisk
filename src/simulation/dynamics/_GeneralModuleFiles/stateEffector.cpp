...
void StateEffector::setStateNameOfPosition(std::string value)
{
    ...
    if (!value.empty()) {
        ...
        bskLogger.bskError("StateEffector: stateNameOfPosition variable must be a non-empty string");
    }
}
...
void StateEffector::setStateNameOfVelocity(std::string value)
{
    ...
    if (!value.empty()) {
        ...
        bskLogger.bskError("StateEffector: stateNameOfVelocity variable must be a non-empty string");
    }
}
...
void StateEffector::setStateNameOfSigma(std::string value)
{
    ...
    if (!value.empty()) {
        ...
        bskLogger.bskError("StateEffector: stateNameOfSigma variable must be a non-empty string");
    }
}
...
void StateEffector::setStateNameOfOmega(std::string value)
{
    ...
    if (!value.empty()) {
        ...
        bskLogger.bskError("StateEffector: stateNameOfOmega variable must be a non-empty string");
    }
}
...
void StateEffector::setPropName_m_SC(std::string value)
{
    ...
    if (!value.empty()) {
        ...
        bskLogger.bskError("StateEffector: propName_m_SC variable must be a non-empty string");
    }
}
...
void StateEffector::setPropName_mDot_SC(std::string value)
{
    ...
    if (!value.empty()) {
        ...
        bskLogger.bskError("StateEffector: propName_mDot_SC variable must be a non-empty string");
    }
}
...
void StateEffector::setPropName_centerOfMassSC(std::string value)
{
    ...
    if (!value.empty()) {
        ...
        bskLogger.bskError("StateEffector: propName_centerOfMassSC variable must be a non-empty string");
    }
}
...
void StateEffector::setPropName_inertiaSC(std::string value)
{
    ...
    if (!value.empty()) {
        ...
        bskLogger.bskError("StateEffector: propName_inertiaSC variable must be a non-empty string");
    }
}
...
void StateEffector::setPropName_inertiaPrimeSC(std::string value)
{
    ...
    if (!value.empty()) {
        ...
        bskLogger.bskError("StateEffector: propName_inertiaPrimeSC variable must be a non-empty string");
    }
}
...
void StateEffector::setPropName_centerOfMassPrimeSC(std::string value)
{
    ...
    if (!value.empty()) {
        ...
        bskLogger.bskError("StateEffector: propName_centerOfMassPrimeSC variable must be a non-empty string");
    }
}
...
void StateEffector::setPropName_centerOfMassDotSC(std::string value)
{
    ...
    if (!value.empty()) {
        ...
        bskLogger.bskError("StateEffector: propName_centerOfMassDotSC variable must be a non-empty string");
    }
}
...
void StateEffector::setPropName_inertialPosition(std::string value)
{
    ...
    if (!value.empty()) {
        ...
        bskLogger.bskError("StateEffector: propName_inertialPosition variable must be a non-empty string");
    }
}
...
void StateEffector::setPropName_inertialVelocity(std::string value)
{
    ...
    if (!value.empty()) {
        ...
        bskLogger.bskError("StateEffector: propName_inertialVelocity variable must be a non-empty string");
    }
}
...
void StateEffector::setPropName_vehicleGravity(std::string value)
{
    ...
    if (!value.empty()) {
        ...
        bskLogger.bskError("StateEffector: propName_vehicleGravity variable must be a non-empty string");
    }
}
...
void StateEffector::setPropName_prescribedPosition(std::string value)
{
    ...
    if (!value.empty()) {
        ...
        bskLogger.bskError("StateEffector: propName_prescribedPosition variable must be a non-empty string");
    }
}
...
void StateEffector::setPropName_prescribedVelocity(std::string value)
{
    ...
    if (!value.empty()) {
        ...
        bskLogger.bskError("StateEffector: propName_prescribedVelocity variable must be a non-empty string");
    }
}
...
void StateEffector::setPropName_prescribedAcceleration(std::string value)
{
    ...
    if (!value.empty()) {
        ...
        bskLogger.bskError("StateEffector: propName_prescribedAcceleration variable must be a non-empty string");
    }
}
...
void StateEffector::setPropName_prescribedAttitude(std::string value)
{
    ...
    if (!value.empty()) {
        ...
        bskLogger.bskError("StateEffector: propName_prescribedAttitude variable must be a non-empty string");
    }
}
...
void StateEffector::setPropName_prescribedAngVelocity(std::string value)
{
    ...
    if (!value.empty()) {
        ...
        bskLogger.bskError("StateEffector: propName_prescribedAngVelocity variable must be a non-empty string");
    }
}
...
void StateEffector::setPropName_prescribedAngAcceleration(std::string value)
{
    ...
    if (!value.empty()) {
        ...
        bskLogger.bskError("StateEffector: propName_prescribedAngAcceleration variable must be a non-empty string");
    }
}
