...
def test_integration(showPlots: bool = False):
    ...
    scene.getBody("cube").setAttitudeRate([0.1, 0.2, 0.3])
    scene.getBody("panel_1").getScalarJoint("panel_1_elevation").setVelocity(0.1)
    scene.getBody("panel_2").getScalarJoint("panel_2_elevation").setVelocity(0.1)
