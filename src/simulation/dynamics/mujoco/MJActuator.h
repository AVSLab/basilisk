...
#include "architecture/msgPayloadDefC/ForceMsgPayload.h"
#include "architecture/msgPayloadDefC/SingleActuatorMsgPayload.h"
#include "architecture/msgPayloadDefC/TorqueMsgPayload.h"
#include "MJObject.h"
 ...
 *
 * This class is designed to handle one `ForceMsgPayload` message to
...
public:
    ...
    ReadFunctor<ForceMsgPayload> forceInMsg; ///< Functor to read force control messages.
};
 ...
 *
 * This class is designed to handle one `TorqueMsgPayload` message to
...
public:
    ...
    ReadFunctor<TorqueMsgPayload> torqueInMsg; ///< Functor to read torque control messages.
};
 ...
 *
 * This class is designed to handle one `ForceMsgPayload` and one `TorqueMsgPayload`
