...
\begin{itemize}
	...
	\item Adds up all of the matrix contributions from the hub and state effectors for the Backsubstitution Method and gives this information to the hub effector
