...
\newcommand{\ModuleName}{spacecraft}
...
\hline
1.5 & Added the ability to prescribe a rotational reference motion & H. Schaub & 2020-10-01\\
\hline
1.6 & Renamed module {\tt spacecraft} & H. Schaub & 2021-02-15\\
\hline
\end{longtable}
}
