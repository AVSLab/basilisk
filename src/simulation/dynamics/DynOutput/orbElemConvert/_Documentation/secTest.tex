...
\end{table}
	...
	\begin{enumerate}
		...
		\begin{figure}[H] 
	\centering
	\subfloat[$e=0.01$ and $a=10^7$km]{\includegraphics[width=0.5\textwidth]{AutoTex/IncEllip_e_1.pdf}}
	\subfloat[$e=0.75$ and $a=10^7$km]{\includegraphics[width=0.5\textwidth]{AutoTex/IncEllip_e_2.pdf}}
	\caption{Inclined Elliptical Orbit Varying $e$}\label{fig:2}
\end{figure}
\begin{figure}[H]
	\centering
	\subfloat[$e=0.5$ and $a=10^7$km]{\includegraphics[width=0.5\textwidth]{AutoTex/IncEllip_a_1.pdf}}
	\subfloat[$e=0.5$ and $a=10$km]{\includegraphics[width=0.5\textwidth]{AutoTex/IncEllip_a_2.pdf}}
...
\pagebreak
	...
	\centering
	\subfloat[$e=0.01$ and $a=10^7$km]{\includegraphics[width=0.5\textwidth]{AutoTex/EquEllip_e_1.pdf}}
	\subfloat[$e=0.75$ and $a=10^7$km]{\includegraphics[width=0.5\textwidth]{AutoTex/EquEllip_e_2.pdf}}
	\caption{Equatorial Elliptical Orbit Varying $e$}
\end{figure}
\begin{figure}[H] \label{fig:5}
	\centering
	\subfloat[$e=0.5$ and $a=10^7$km]{\includegraphics[width=0.5\textwidth]{AutoTex/EquEllip_a_1.pdf}}
	\subfloat[$e=0.5$ and $a=10$km]{\includegraphics[width=0.5\textwidth]{AutoTex/EquEllip_a_2.pdf}}
...
\end{figure}
	...
	\centering
	\subfloat[$a=10^7$km]{\includegraphics[width=0.5\textwidth]{AutoTex/IncCirc_1.pdf}}
	\subfloat[$a=10$km]{\includegraphics[width=0.5\textwidth]{AutoTex/IncCirc_2.pdf}}
...
\begin{figure}[H]
	\centering
	\subfloat[$a=10^7$km]{\includegraphics[width=0.5\textwidth]{AutoTex/EquCirc_1.pdf}}
	\subfloat[$a=10$km]{\includegraphics[width=0.5\textwidth]{AutoTex/EquCirc_2.pdf}}
...
\end{figure}
	...
	\centering
	\subfloat[$a=10^7$km]{\includegraphics[width=0.5\textwidth]{AutoTex/IncPara_1.pdf}}
	\subfloat[$a=10$km]{\includegraphics[width=0.5\textwidth]{AutoTex/IncPara_2.pdf}}
...
\begin{figure}[H]
	\centering
	\subfloat[$a=10^7$km]{\includegraphics[width=0.5\textwidth]{AutoTex/EquPara_1.pdf}}
	\subfloat[$a=10$km]{\includegraphics[width=0.5\textwidth]{AutoTex/EquPara_2.pdf}}
...
\end{figure}
	...
	\centering
	\subfloat[$e=1.1$, $a=-10^5$km]{\includegraphics[width=0.5\textwidth]{AutoTex/IncHyp_e_1.pdf}}
	\subfloat[$e=1.5$, $a=-10^5$km]{\includegraphics[width=0.5\textwidth]{AutoTex/IncHyp_e_2.pdf}}
	\caption{Inclined Hyperbolic Orbit Varying $e$}
\end{figure}
\begin{figure}[H] \label{fig:11}
	\centering
	\subfloat[$e=1.3$, $a=-10$km]{\includegraphics[width=0.5\textwidth]{AutoTex/IncHyp_a_1.pdf}}
	\subfloat[$e=1.3$, $a=-10^5$km]{\includegraphics[width=0.5\textwidth]{AutoTex/IncHyp_a_2.pdf}}
...
\end{figure}
		...
		\begin{figure}[H]
	\centering
	\subfloat[$e=1.1$,$a=-10^5$km]{\includegraphics[width=0.5\textwidth]{AutoTex/EquHyp_e_1.pdf}}
	\subfloat[$e=1.5$, $a=-10^5$km]{\includegraphics[width=0.5\textwidth]{AutoTex/EquHyp_e_2.pdf}}
	\caption{Equatorial Hyperbolic Orbit Varying $e$}\label{fig:12}
\end{figure}
\begin{figure}[H]
	\centering
	\subfloat[$e=1.3$, $a=-10$km]{\includegraphics[width=0.5\textwidth]{AutoTex/EquHyp_a_1.pdf}}
	\subfloat[$e=1.3$, $a=-10^5$km]{\includegraphics[width=0.5\textwidth]{AutoTex/EquHyp_a_2.pdf}}
...
\end{table}
	...
	\begin{enumerate}
		...
		%		\begin{figure}[H]
		%			\centering
		%			\subfloat[$e=0.01$ and $a=10^7$km]{\includegraphics[width=0.5\textwidth]{Figures/IncEllipElem_e_1.png}}
		%			\subfloat[$e=0.75$ and $a=10^7$km]{\includegraphics[width=0.5\textwidth]{Figures/IncEllipElem_e_2.png}}
		%			\caption{Inclined Elliptical Orbit Varying $e$}\label{fig:14}
		%		\end{figure}
		%		\begin{figure}[H]
		%			\centering
		%			\subfloat[$e=0.5$ and $a=10^7$km]{\includegraphics[width=0.5\textwidth]{Figures/IncEllipElem_a_1.png}}
		%			\subfloat[$e=0.5$ and $a=10$km]{\includegraphics[width=0.5\textwidth]{Figures/IncEllipElem_a_2.png}}
		...
		%			\centering
		%			\subfloat[$e=0.01$ and $a=10^7$km]{\includegraphics[width=0.5\textwidth]{Figures/EquEllipElem_e_1.png}}
		%			\subfloat[$e=0.75$ and $a=10^7$km]{\includegraphics[width=0.5\textwidth]{Figures/EquEllipElem_e_2.png}}
		%			\caption{Equatorial Elliptical Orbit Varying $e$}
		%		\end{figure}
		%		\begin{figure}[H] \label{fig:17}
		%			\centering
		%			\subfloat[$e=0.5$ and $a=10^7$km]{\includegraphics[width=0.5\textwidth]{Figures/EquEllipElem_a_1.png}}
		%			\subfloat[$e=0.5$ and $a=10$km]{\includegraphics[width=0.5\textwidth]{Figures/EquEllipElem_a_2.png}}
		%			\caption{Equatorial Elliptical Orbit Varying $a$}
		%		\end{figure}
		%		\pagebreak
		\item \underline{Inclined Circular Orbit ($e=0$, \quad $a>0$,\quad $\omega=0$)}\\
		...
		%		\begin{figure}[H]
		%			\centering
		%			\subfloat[$a=10^7$km]{\includegraphics[width=0.5\textwidth]{Figures/IncCircElem_1.png}}
		%			\subfloat[$a=10$km]{\includegraphics[width=0.5\textwidth]{Figures/IncCircElem_2.png}}
		%			\caption{Inclined Circular Orbit Varying $a$}
		%		\end{figure}
		\item \underline{Equatorial Circular Orbit ($e=0$,\quad $a>0$, \quad $\omega=0$, \quad $i=0$, \quad $\Omega=0$)}\\
		...
		%		\begin{figure}[H]
		%			\centering
		%			\subfloat[$a=10^7$km]{\includegraphics[width=0.5\textwidth]{Figures/EquCircElem_1.png}}
		%			\subfloat[$a=10$km]{\includegraphics[width=0.5\textwidth]{Figures/EquCircElem_2.png}}
		...
		%		\begin{figure}[H]
		%			\centering
		%			\subfloat[$a=-10$km]{\includegraphics[width=0.5\textwidth]{Figures/IncParaElem_1.png}}
		%			\subfloat[$a=-10^5$km]{\includegraphics[width=0.5\textwidth]{Figures/IncParaElem_2.png}}
		%			\caption{Inclined Parabolic Orbit Varying $a$}
		%		\end{figure}
		\item \underline{Equatorial Parabolic Orbit ($e=1.0$, \quad $a=-r_p$, \quad $i=0$, \quad $\Omega=0$)}\\
		...
		%		\begin{figure}[H]
		%			\centering
		%			\subfloat[$a=-10$km]{\includegraphics[width=0.5\textwidth]{Figures/EquParaElem_1.png}}
		%			\subfloat[$a=-10^5$km]{\includegraphics[width=0.5\textwidth]{Figures/EquParaElem_2.png}}
		...
		%		\begin{figure}[H]
		%			\centering
		%			\subfloat[$e=1.1$, $a=-10^5$km]{\includegraphics[width=0.5\textwidth]{Figures/IncHypElem_e_1.png}}
		%			\subfloat[$e=1.5$, $a=-10^5$km]{\includegraphics[width=0.5\textwidth]{Figures/IncHypElem_e_2.png}}
		%			\caption{Inclined Hyperbolic Orbit Varying $e$}
		%		\end{figure}
		%		\begin{figure}[H]
		%			\centering
		%			\subfloat[$e=1.3$, $a=-10$km]{\includegraphics[width=0.5\textwidth]{Figures/IncHypElem_a_1.png}}
		%			\subfloat[$e=1.3$, $a=-10^5$km]{\includegraphics[width=0.5\textwidth]{Figures/IncHypElem_a_2.png}}
		%			\caption{Inclined Hyperbolic Orbit Varying $a$}
		%		\end{figure}
		%		\pagebreak
		\item \underline{Equatorial Hyperbolic Orbit ($e>1.0$, \quad $a<0$, \quad $i=0$, \quad $\Omega = 0$)}\\
		...
		%		\begin{figure}[H]
		%			\centering
		%			\subfloat[$a=-10$km]{\includegraphics[width=0.5\textwidth]{Figures/EquHypElem_e_1.png}}
		%			\subfloat[$a=-10^5$km]{\includegraphics[width=0.5\textwidth]{Figures/EquHypElem_e_2.png}}
		%			\caption{Equatorial Hyperbolic Orbit Varying $a$}\label{fig:24}
		%		\end{figure}
		%		\begin{figure}[H]
		%			\centering
		%			\subfloat[$e=1.3$, $a=-10$km]{\includegraphics[width=0.5\textwidth]{Figures/EquHypElem_a_1.png}}
		%			\subfloat[$e=1.3$, $a=-10^5$km]{\includegraphics[width=0.5\textwidth]{Figures/EquHypElem_a_2.png}}
