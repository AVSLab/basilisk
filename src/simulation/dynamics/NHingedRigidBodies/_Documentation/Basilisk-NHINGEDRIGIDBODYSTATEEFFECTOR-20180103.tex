...
\newcommand{\ModuleName}{nHingedRigidBodyStateEffector}
\newcommand{\subject}{N Hinged Rigid Body Dynamics Model}
\newcommand{\status}{Initial Draft}
\newcommand{\preparer}{C. Allard}
\newcommand{\summary}{The N hinged rigid body class is an instantiation of the state effector abstract class. The integrated test is validating the interaction between the N hinged rigid body module and the rigid body hub that it is attached to.}
...
\hline
1.0 & Initial Draft & C. Allard & 20180103\\
\hline
\end{longtable}
}
