...
\newcommand{\ModuleName}{RigidBodyContactStateEffector}
\newcommand{\subject}{Rigid Body Contact State Effector}
\newcommand{\status}{Initial Draft}
\newcommand{\preparer}{J.D. Nelson}
\newcommand{\summary}{}
...
\hline
1.0 & Initial Draft & J.D. Nelson & 20201005\\
\hline
\end{longtable}
}
