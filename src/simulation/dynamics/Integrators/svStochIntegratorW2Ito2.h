...
#ifndef svStochIntegratorW2Ito2_h
#define svStochIntegratorW2Ito2_h
 ...
 */
class svStochIntegratorW2Ito2 : public svIntegratorWeakStochasticRungeKutta<4> {
public:
    svStochIntegratorW2Ito2(DynamicObject* dyn); //!< Constructor
private:
    static SRKCoefficients<4> getCoefficients();
};

#endif /* svStochIntegratorW2Ito2_h */
