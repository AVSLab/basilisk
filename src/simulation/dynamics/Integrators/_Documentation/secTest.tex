...
\begin{figure}[t]
	\centerline{
		\includegraphics[]{../../../../tests/scenarios/_Documentation/AutoTex/scenarioIntegrators}
	}
...
\begin{table}[h]
	...
	\begin{tabular}{c | c | p{4in} } % Column formatting,
		...
		\\ \hline
		``rk4"		  	&
		\input{../../../../tests/scenarios/_Documentation/AutoTex/scenarioIntegratorsTestMsg-rk4}      	  &
		\input{../../../../tests/scenarios/_Documentation/AutoTex/scenarioIntegratorsMsg-rk4}
		\\ \hline
		``euler''	   	           	&
		\input{../../../../tests/scenarios/_Documentation/AutoTex/scenarioIntegratorsTestMsg-euler}           		&      
		\input{../../../../tests/scenarios/_Documentation/AutoTex/scenarioIntegratorsMsg-euler}  
		\\ \hline
		``rk2''      	&
		\input{../../../../tests/scenarios/_Documentation/AutoTex/scenarioIntegratorsTestMsg-rk2}
		&
		\input{../../../../tests/scenarios/_Documentation/AutoTex/scenarioIntegratorsMsg-rk2}
		\\
		\hline\hline
	\end{tabular}
\end{table}
