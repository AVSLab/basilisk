...
def generate():
    ...
    nsteps = len(ts) - 1
    cases = []
    # DRI1 and RI1 share the same step; both are exercised on the same non-commutative
    # linear Ito problem (a different seed per method).
    for method, seed in [("DRI1", 31), ("RI1", 32)]:
