...
reference:
  ...
  * DRI1 / RI1 (Debrabant-Roessler / Roessler, Ito) - StochasticDiffEq.jl's DRI1 and RI
    non-diagonal branches raise an UndefVarError and cannot solve a coupled-noise problem
    at all. RI1 shares DRI1's step but with a different coefficient tableau.
...
def _buildSim(case: dict):
    from conftest import buildPrescribedNoiseSim
