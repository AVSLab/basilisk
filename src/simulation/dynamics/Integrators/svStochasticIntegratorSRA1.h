...
#ifndef svStochasticIntegratorSRA1_h
#define svStochasticIntegratorSRA1_h

#include "../_GeneralModuleFiles/svIntegratorStrongStochasticRungeKuttaSRA.h"

/** @brief Strong-order 1.5, weak-order 2 stochastic integrator for additive-noise SDEs.
 *
 * @warning Stochastic integration is in beta.
 *
 * This is the ``SRA1`` method (Roessler SRA family). Coefficients for the
 * ``SRA1`` tableau.
 *
...
#endif /* svStochasticIntegratorSRA1_h */
