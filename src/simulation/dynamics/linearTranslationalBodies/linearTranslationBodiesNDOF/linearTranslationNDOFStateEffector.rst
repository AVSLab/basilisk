...
The assembled joint mass matrix must also be finite before its rank is checked. Massless
intermediate bodies remain supported when the joint mass matrix is nonsingular.
