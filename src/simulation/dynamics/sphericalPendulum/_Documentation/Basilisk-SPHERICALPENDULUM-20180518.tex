...
\newcommand{\ModuleName}{sphericalPendulum}
\newcommand{\subject}{Spherical Pendulum Dynamics Model}
\newcommand{\status}{Tested}
\newcommand{\preparer}{P. Cappuccio}
\newcommand{\summary}{The Basilisk sphericalPendulum model module is responsible for simulating an oscillating spherical pendulum in spacecraft tanks. This phenomenon makes the fuel exchange energy and momentum with the spacecraft, thus creates disturbances on attitude and on precise orbit determination. This model together with the linearSpringMassDamper, that is a spring mass damper model, provides an efficient and precise simulation of the real phenomenon.}
...
\hline
1.0 & Initial Draft & P. Cappuccio & 20170901\\
\hline
1.1 & Initial Draft & C. Allard & 20180518\\
\hline
\end{longtable}
}
