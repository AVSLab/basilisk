...
//! @brief Container for basic aero parameters - the spacecraft's atmosphere-relative velocity, its projected area, and its drag coefficient.
typedef struct {
...
/*! @brief aero dynamic effector */
class AeroDynamicEffector: public SysModel, public DynamicEffector {
public:
    AeroDynamicEffector();
    ~AeroDynamicEffector();
