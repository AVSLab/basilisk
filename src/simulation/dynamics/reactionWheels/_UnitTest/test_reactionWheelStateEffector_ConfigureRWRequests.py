...
def defaultReactionWheel():
    ...
    RW.rWB_B = [[0.0], [0.0], [0.0]]
    RW.gsHat_B = [[1.0], [0.0], [0.0]]
    RW.w2Hat0_B = [[0.0], [1.0], [0.0]]
    RW.w3Hat0_B = [[0.0], [0.0], [1.0]]
...
def unitSimReactionWheel(show_plots, useFlag, testCase):
    ...
    if testCase == "basic":
        ...
        expOut["u_current"] = [0.0, 0.0001]

    elif testCase == "speedSaturation":
        RWs.append(defaultReactionWheel())
        RWs[0].Omega_max = 50.0
        RWs[1].Omega_max = 50.0
        RWs[2].Omega_max = 50.0
        RWs[0].Omega = 49.0
        RWs[1].Omega = 51.0
        RWs[2].Omega = -52.0
        u_cmd = [1.5, 1.5, 1.5]
    ...
    ReactionWheel.ConfigureRWRequests(0.0)
