...
\newcommand{\subject}{Derivation of Reaction Wheel Jitter Backsubstitution}
\newcommand{\status}{Draft}
\newcommand{\preparer}{J. Alcorn, C. Allard}
\newcommand{\summary}{This document derives the Backsubstitution Method for reaction wheel jitter to conform with Basilisk's dynamics architecture.}
...
\section{Balanced Reaction Wheel Backsubstitution}
...
\subsection{Backsubstitution Derivation}
...
\subsection{Backsubstitution Contribution Matrices}
...
\section{Imbalanced Reaction Wheel Backsubstitution}
\subsection{Equations of Motion}
...
\subsection{Derivation of Backsubstitution}
