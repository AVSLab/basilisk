...
\end{equation}
These are the contributions needed for the Backsubstitution Method used in spacecraft plus.
...
The first step in the Backsubstitution Method is to solve the motor torque equation for $\dot{\Omega}_i$ in terms of $\ddot{\bm{r}}_{B/N}$ and $\dot{\bm\omega}_{\cal B/N}$
\begin{multline}
\dot{\Omega}_i
