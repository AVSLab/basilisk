...
*/
void
MsmForceTorque::Reset(uint64_t CurrentSimNanos)
{
 ...
 */
void
MsmForceTorque::addSpacecraftToModel(Message<SCStatesMsgPayload>* tmpScMsg,
...
*/
void
MsmForceTorque::UpdateState(uint64_t CurrentSimNanos)
{
