...
/*! @brief This module uses the Multi-Sphere-Method (MSM) to evaluate the mutual electrostatic force and torque
 * interactions between a series of spacecraft object.  The charging is specified through a voltage where the object is
 * assumed to have aconstant voltaged across the surface.  The MSM model for each space object is given through a list
 * of body-fixed sphere locations and sphere radii.  See `Multi-Sphere Method for Modeling Electrostatic Forces and
 * Torques <http://dx.doi.org/10.1016/j.asr.2012.08.014 >`__ for more information on the MSM method.
 */
