...
#ifndef SCPlusMassPropsSimMsg_C_H
#define SCPlusMassPropsSimMsg_C_H

#include <stdint.h>
#include "../../../simMessages/scPlusMassPropsSimMsg.h"

typedef struct {
    SCPlusMassPropsSimMsg payload;
    SCPlusMassPropsSimMsg *payloadPointer;
} SCPlusMassPropsSimMsg_C;
