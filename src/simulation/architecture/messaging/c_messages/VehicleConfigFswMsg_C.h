...
#ifndef VehicleConfigFswMsg_C_H
#define VehicleConfigFswMsg_C_H

#include <stdint.h>
#include "../../../../fswAlgorithms/fswMessages/vehicleConfigFswMsg.h"

typedef struct {
    VehicleConfigFswMsg payload;
    VehicleConfigFswMsg *payloadPointer;
} VehicleConfigFswMsg_C;

#ifdef __cplusplus
extern "C" {
#endif

void VehicleConfigFswMsg_cpp_subscribe(VehicleConfigFswMsg_C *subscriber, void* source);

void VehicleConfigFswMsg_C_subscribe(VehicleConfigFswMsg_C *subscriber, VehicleConfigFswMsg_C *source);

void VehicleConfigFswMsg_C_claim(VehicleConfigFswMsg_C *coowner, VehicleConfigFswMsg_C *data);
