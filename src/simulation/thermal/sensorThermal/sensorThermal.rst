...
.. math::
    \dot{Q}_{\text{absorb}} = illuminationFactor \cdot \alpha \cdot S \cdot A_{\text{proj}}

The :math:`illuminationFactor` is an indication of whether or not the sensor is in eclipse. An illuminationFactor of 0 indicates the sensor
is in eclipse. Likewise, an illuminationFactor of 1 indicates the sensor is not in eclipse. The :math:`\alpha` parameter
