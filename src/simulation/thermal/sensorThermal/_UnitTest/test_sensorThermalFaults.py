...
#
# Purpose:  Test the proper function of the faulty behaviors of the sensorThermal module.
#           For basic functionality, results are compared to simple truth values.
...
def run(tempFault):
    ...
    if tempFault == "TEMP_FAULT_NOMINAL":
        ...
        biasVal = 1.0
        sensorThermalModel.senBias = biasVal
    ...
    sensorTemp = np.array(tempLog.temperature)
    print(sensorThermalModel.RNGSeed)
