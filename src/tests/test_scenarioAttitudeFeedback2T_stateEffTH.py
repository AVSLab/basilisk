...
import scenarioAttitudeFeedback2T_stateEffTH
...
def test_bskAttitudeFeedback2T_stateEffTH(show_plots, useDVThrusters):
    ...
    try:
        figureList = scenarioAttitudeFeedback2T_stateEffTH.run(
            show_plots, useDVThrusters
        )
        ...
        testFailCount += 1
        testMessages.append("scenarioAttitudeFeedback2T_stateEffTH  test are failed.")
