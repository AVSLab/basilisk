...
sys.path.append(path + '/../examples/08-LivePlotting')
...
def test_scenarioBasicOrbitLive(show_plots, orbitCase, useSphericalHarmonics, planetCase):
    ...
    livePlots = False
    posData, figureList = scenarioBasicOrbitLivePlot.run(show_plots, livePlots, orbitCase, useSphericalHarmonics, planetCase)
