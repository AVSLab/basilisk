...
#
#         # FSW process outputs
#         sigma_RN = self.pullMessageLogData(self.get_FswModel().trackingErrorData.inputRefName + ".sigma_RN", range(3))
#         omega_RN_N = self.pullMessageLogData(self.get_FswModel().trackingErrorData.inputRefName + ".omega_RN_N", range(3))
#         sigma_BR = self.pullMessageLogData(self.get_FswModel().trackingErrorData.outputDataName + ".sigma_BR", range(3))
#         omega_BR_B = self.pullMessageLogData(self.get_FswModel().trackingErrorData.outputDataName + ".omega_BR_B", range(3))
...
# ~~~~~~~~~~~~~
# This event is triggered when a user calls `self.modeRequest = 'hillPoint'` in any current or future
