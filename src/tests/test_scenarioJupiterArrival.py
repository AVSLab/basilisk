...
def test_scenarioBasicOrbit(show_plots):
    ...
    try:
        posData, figureList = scenarioJupiterArrival.run(show_plots)
    ...
    if posData > accuracy:
        testFailCount += 1
        testMessages += "FAILED: scenarioJupiterArrival r_BN_N Norm test"
