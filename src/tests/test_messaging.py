...
def test_cpp_msg_subscription_check():
    ...
    for el in cppMessages:
        ...
        if msgB_subscriber.isSubscribedTo(msgA) != 1:
            testFailCount += 1
            testMessages.append(
                el + ": msgB_subscriber.isSubscribedTo(msgA) should be True"
            )
        if msgC_subscriber.isSubscribedTo(msgB) != 1:
            testFailCount += 1
            testMessages.append(
                el + ": msgC_subscriber.isSubscribedTo(msgB) should be True"
            )
        if msgC_subscriber.isSubscribedTo(msgA) != 0:
            testFailCount += 1
            testMessages.append(
                el + ": msgC_subscriber.isSubscribedTo(msgA) should be False"
            )
        ...
        if msgB_subscriber.isSubscribedTo(msgC) != 1:
            testFailCount += 1
            testMessages.append(
                el + ": msgB_subscriber.isSubscribedTo(msgC) should be True"
            )
        if msgC_subscriber.isSubscribedTo(msgA) != 1:
            testFailCount += 1
            testMessages.append(
                el + ": msgC_subscriber.isSubscribedTo(msgA) should be True"
            )
        if msgC_subscriber.isSubscribedTo(msgB) != 0:
            testFailCount += 1
            testMessages.append(
                el + ": msgC_subscriber.isSubscribedTo(msgB) should be False"
            )
...
def test_cpp_2_c_msg_subscription_check():
    ...
    for el in common_messages:
        ...
        if msgD_subscriber.isSubscribedTo(msgB) != 1:
            testFailCount += 1
            testMessages.append(
                el + ": msgD_subscriber.isSubscribedTo(msgB) should be True"
            )
        if msgD_subscriber.isSubscribedTo(msgA) != 0:
            testFailCount += 1
            testMessages.append(
                el + ": msgD_subscriber.isSubscribedTo(msgA) should be False"
            )
        if msgC_subscriber.isSubscribedTo(msgB) != 0:
            testFailCount += 1
            testMessages.append(
        ...
        if msgD_subscriber.isSubscribedTo(msgA) != 1:
            testFailCount += 1
            testMessages.append(
                el + ": msgD_subscriber.isSubscribedTo(msgA) should be True"
            )
        if msgC_subscriber.isSubscribedTo(msgA) != 0:
            testFailCount += 1
            testMessages.append(
        ...
        if msgD_subscriber.isSubscribedTo(msgB) != 0:
            testFailCount += 1
            testMessages.append(
                el + ": msgD_subscriber.isSubscribedTo(msgB) should be False"
            )
