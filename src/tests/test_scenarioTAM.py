...
@pytest.mark.parametrize(
    "orbitCase, planetCase, useBias, useBounds",
    [
...
def test_scenarioTAM(show_plots, orbitCase, planetCase, useBias, useBounds):
    ...
    magData, tamData, figureList, simulationTime = scenarioTAM.run(
        show_plots, orbitCase, planetCase, useBias, useBounds
    )
    ...
    if (
        ...
        trueMag = [
            ...
            [0.0000000000000000e00, 0.0000000000000000e00, -9.9999999999999995e-07],
            [0.0000000000000000e00, 0.0000000000000000e00, -9.9999999999999995e-07],
    ...
    testFailCount, testMessages = unitTestSupport.compareArray(
        trueMag, dataMagRed, accuracy, "TAM Measurements", testFailCount, testMessages
    )
