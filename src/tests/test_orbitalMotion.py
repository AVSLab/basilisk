...
def test_orbitalMotion(show_plots):
    ...
    rv2elem_parabCValue = np.array(
        [999.927, 1, 0.102545, -3.14159, -0.552287, -1.94593]
    )
    rv2elem_parab_Value = np.array(
        [
            elements3.a,
            elements3.e,
            elements3.i,
    ...
    e_count += arrayEqualCheck(
        rv2elem_parab_Value, rv2elem_parabCValue, "rv2elem_parab"
    )
    ...
    trueElements_p = np.array(
        [
            1000.07546442015950560744386166334152,
