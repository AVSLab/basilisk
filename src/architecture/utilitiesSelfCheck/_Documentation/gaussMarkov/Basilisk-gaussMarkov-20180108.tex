...
\newcommand{\ModuleName}{gaussMarkov}
\newcommand{\subject}{Gauss Markov Noise Model}
\newcommand{\status}{Tested}
\newcommand{\preparer}{S. Carnahan}
\newcommand{\summary}{The Basilisk Gauss Markov Utility adds Gauss Markov noise with random walk and walk bounds to any model that uses it.}
