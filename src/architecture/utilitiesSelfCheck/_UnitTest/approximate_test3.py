...
def BSplineTestFunction(P,n,XDot_flag, XDDot_flag,accuracy):
    ...
    plt.show()
    plt.scatter(Output.T_way_calc,X2,c = 'b')
    ...
    plt.legend(["Way Points","LS Approximation"])
    plt.show()
    plt.scatter(Output.T_way_calc,X3,c = 'b')
    ...
    plt.show()
    plt.scatter(Output.T_way_calc,Input.X2Dot,c = 'b')
    ...
    plt.show()
    plt.scatter(Output.T_way_calc,Input.X3Dot,c = 'b')
