...
\newcommand{\ModuleName}{saturate}
\newcommand{\subject}{Saturate C++ model}
\newcommand{\status}{Tested}
\newcommand{\preparer}{S. Carnahan}
\newcommand{\summary}{The Basilisk saturate model is used to saturate inputs between high and low allowable values. It works on Eigen::VectorXd values for states and uses Eigen::MatrixXd (n x 2) as the state bounds inputs.}
