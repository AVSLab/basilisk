...
extern "C"
{
    ...
    double vMax(double* v,
                size_t dim); /* Non-sorted, non-optimized algorithm for finding the max of a small 1-D array*/
    double vMaxAbs(double* v, size_t dim); /* Non-sorted, non-optimized algorithm for finding the max of the absolute
                                              values of the elements of a small 1-D array*/
