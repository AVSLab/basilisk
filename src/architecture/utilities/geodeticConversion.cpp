...
/*! Converts from a planet-centered inertial position (i.e., J2000 ECI) to a planet-centered, planet-fixed position
...
*/
Eigen::Vector3d
PCI2PCPF(Eigen::Vector3d pciPosition, double J20002Pfix[3][3])
{
...
/*! Converts from a planet-centered, planet-fixed coordinates to latitude/longitude/altitude (LLA) coordinates given a
planet radius.
...
*/
Eigen::Vector3d
PCPF2LLA(Eigen::Vector3d pcpfPosition, double planetEqRad, double planetPoRad)
{
...
/*! Converts from a planet-centered inertial coordinates to latitutde/longitude/altitude (LLA) coordinates given a
planet radius and rotation matrix.
...
*/
Eigen::Vector3d
PCI2LLA(Eigen::Vector3d pciPosition, double J20002Pfix[3][3], double planetEqRad, double planetPoRad)
{
...
*/
Eigen::Vector3d
LLA2PCPF(Eigen::Vector3d llaPosition, double planetEqRad, double planetPoRad)
{
...
/*! Converts from a Lat/Long/Altitude coordinates to planet-centered inertialcoordinates given a planet radius and
rotation matrix.
...
*/
Eigen::Vector3d
PCPF2PCI(Eigen::Vector3d pcpfPosition, double J20002Pfix[3][3])
{
    // cArray2EigenMatrixd expects a column major input, thus the result is transposed
...
*/
Eigen::Vector3d
LLA2PCI(Eigen::Vector3d llaPosition, double J20002Pfix[3][3], double planetEqRad, double planetPoRad)
{
...
Eigen::Matrix3d
C_PCPF2SEZ(double lat, double longitude)
{
    double m1[3][3];
    double m2[3][3];
