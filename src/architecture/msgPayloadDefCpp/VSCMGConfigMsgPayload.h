...
//@endcond
{
    ...
    Eigen::Vector3d
      rGB_B; //!< [m], vector pointing from body frame B origin to VSCMG frame G origin in B frame components
    ...
    double wheelLinearFrictionRatio;  //!< [%] ratio relative to max wheel speed value up to which the friction behaves
                                      //!< linearly
    ...
    double gimbalLinearFrictionRatio; //!< [%] ratio relative to max gimbal rate value up to which the friction behaves
                                      //!< linearly

    Eigen::Matrix3d
      IGPntGc_B; //!< [kg-m^2] inertia of the gimbal about point Gc (center of mass of the gimbal) in B frame components
    Eigen::Matrix3d
      IWPntWc_B; //!< [kg-m^2] inertia of the wheel about point Wc (center of mass of the wheel) in B frame components
    ...
    Eigen::Vector3d rGcG_G; //!< [m] vector pointing from VSCMG frame G origin to point Gc (center of mass of the
                            //!< gimbal) in G frame components
    Eigen::Vector3d rGcG_B; //!< [m] vector pointing from VSCMG frame G origin to point Gc (center of mass of the
                            //!< gimbal) in B frame components
    Eigen::Vector3d rGcB_B; //!< [m] vector pointing from body frame B origin to point Gc (center of mass of the gimbal)
                            //!< in B frame components
    Eigen::Vector3d rWcB_B; //!< [m] vector pointing from body frame B origin to point Wc (center of mass of the wheel)
                            //!< in B frame components
    Eigen::Vector3d rWcG_B; //!< [m] vector pointing from VSCMG frame G origin to point Wc (center of mass of the wheel)
                            //!< in B frame components
