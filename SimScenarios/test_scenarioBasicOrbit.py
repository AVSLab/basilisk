...
@pytest.mark.parametrize("orbitCase, useSphericalHarmonics", [
      (0, False)
    , (1, False)
    , (2, False)
    , (0, True)
...
def test_scenarioOrbitEarth(show_plots, orbitCase, useSphericalHarmonics):
...
# a basic Basilisk simulation.  The scenario is setup to be run in four different setups:
# Setup | orbitCase  | useSphericalHarmonics
# ----- | ------------------- | ----------
# 1     | 0 (LEO)             | False
# 2     | 1 (GTO)             | False
# 3     | 2 (GEO)             | False
...
# semi-major axis time history plot (with sphereical harmonics turned on).
#
...
# ![Inertial Position Coordinates History](Images/Scenarios/scenarioBasicOrbit100.svg "Position history")
# ![Perifocal Orbit Illustration](Images/Scenarios/scenarioBasicOrbit200.svg "Orbit Illustration")
#
# Setup 2
# -----
#
...
# inclination.  The
# resulting position coordinates and orbit illustration are shown below.
# ![Inertial Position Coordinates History](Images/Scenarios/scenarioBasicOrbit110.svg "Position history")
# ![Perifocal Orbit Illustration](Images/Scenarios/scenarioBasicOrbit210.svg "Orbit Illustration")
#
# Setup 3
# -----
#
...
# inclination.  The
# resulting position coordinates and orbit illustration are shown below.
# ![Inertial Position Coordinates History](Images/Scenarios/scenarioBasicOrbit120.svg "Position history")
# ![Perifocal Orbit Illustration](Images/Scenarios/scenarioBasicOrbit220.svg "Orbit Illustration")
#
#  Setup 4
# -----
#
...
#        )
# ~~~~~~~~~~~~~
# This case illustrates a circular LEO with non-zero orbit
...
# ![Inertial Position Coordinates History](Images/Scenarios/scenarioBasicOrbit101.svg "Position history")
# ![Perifocal Orbit Illustration](Images/Scenarios/scenarioBasicOrbit201.svg "Orbit Illustration")
#
def run(doUnitTests, show_plots, orbitCase, useSphericalHarmonics):
    ...
    if doUnitTests:
        ...
        if orbitCase == 0 and useSphericalHarmonics == False:
            truePos = [
        ...
        if orbitCase == 1 and useSphericalHarmonics == False:
            truePos = [
        ...
        if orbitCase == 2 and useSphericalHarmonics == False:
            truePos = [
        ...
        if orbitCase == 0 and useSphericalHarmonics == True:
            truePos = [
                  [-2.8168016010234905e+06, 5.2481748469161475e+06, 3.6771572646772973e+06]
