void dataInitialization(EMMConfigData *ConfigData) {
	ConfigData->cssComm.cssComm.ChebyCount = 14;
	ConfigData->cssComm.cssComm.KellyCheby[0] = -1734963.34695;
	ConfigData->cssComm.cssComm.KellyCheby[1] = 3294117.1461;
	ConfigData->cssComm.cssComm.KellyCheby[2] = -2816333.29462;
	ConfigData->cssComm.cssComm.MaxSensorValue = 0.0005;
	ConfigData->cssComm.cssComm.NumSensors = 8;
	strcpy(ConfigData->cssComm.cssComm.OutputDataName,"css_data_aggregate");
	ConfigData->cssComm.cssComm.OutputMsgID = 0;
	strcpy(ConfigData->cssComm.cssComm.SensorListName,"css_sensors_data");
	ConfigData->cssComm.cssComm.SensorMsgID = 0;
	strcpy(ConfigData->imuComm.imuComm.InputDataName,"imu_meas_data");
	strcpy(ConfigData->imuComm.imuComm.InputPropsName,"adcs_config_data");
	strcpy(ConfigData->imuComm.imuComm.OutputDataName,"parsed_imu_data");
	ConfigData->imuComm.imuComm.OutputMsgID = 0;
	ConfigData->imuComm.imuComm.PropsMsgID = 0;
	ConfigData->imuComm.imuComm.SensorMsgID = 0;
	ConfigData->imuComm.imuComm.platform2BdyDCM[0] = 0.0;
	ConfigData->imuComm.imuComm.platform2BdyDCM[1] = 0.0;
	ConfigData->imuComm.imuComm.platform2BdyDCM[2] = 0.0;
	ConfigData->imuComm.imuComm.platform2StrDCM[0] = 1.0;
	ConfigData->imuComm.imuComm.platform2StrDCM[1] = 0.0;
	ConfigData->imuComm.imuComm.platform2StrDCM[2] = 0.0;
	strcpy(ConfigData->stComm.stComm.InputDataName,"star_tracker_state");
	strcpy(ConfigData->stComm.stComm.InputPropsName,"adcs_config_data");
	strcpy(ConfigData->stComm.stComm.OutputDataName,"parsed_st_data");
	ConfigData->stComm.stComm.OutputMsgID = 0;
	ConfigData->stComm.stComm.PropsMsgID = 0;
	ConfigData->stComm.stComm.SensorMsgID = 0;
	ConfigData->stComm.stComm.T_BdyPlatform[0] = 0.0;
	ConfigData->stComm.stComm.T_BdyPlatform[1] = 0.0;
	ConfigData->stComm.stComm.T_BdyPlatform[2] = 0.0;
	ConfigData->stComm.stComm.T_StrPlatform[0] = 1.0;
	ConfigData->stComm.stComm.T_StrPlatform[1] = 0.0;
	ConfigData->stComm.stComm.T_StrPlatform[2] = 0.0;
