...
class BSKDynamicModels:
    ...
    def SetSpacecraftHub(self):
        ...
        """
        self.scObject.ModelTag = "deputy" + str(self.spacecraftIndex)
        self.I_sc = [900., 0., 0.,
                     0., 800., 0.,
                     0., 0., 600.]
    ...
    def SetSimpleNavObject(self):
        """
        Defines the naviagtion module.
        """
        self.simpleNavObject.ModelTag = "SimpleNavigation_deputy" + str(self.spacecraftIndex)
    ...
    def SetReactionWheelDynEffector(self):
        ...
        self.rwFactory.addToSpacecraft("RW_deputy" + str(self.spacecraftIndex), self.rwStateEffector, self.scObject)
