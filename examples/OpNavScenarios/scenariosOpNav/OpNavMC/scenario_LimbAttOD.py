...
class scenario_OpNav(BSKSim):
    ...
    def log_outputs(self):
        ...
        self.msgRecList[self.retainedMessageNameLimb] = (
            FswModel.limbFinding.opnavLimbOutMsg.recorder(samplingTime)
        )
        self.AddModelToTask(
            DynModel.taskName, self.msgRecList[self.retainedMessageNameLimb]
        )
