...
def run(showPlots: bool = False, visualize: bool = False):
    ...
    gravity = ConstantGravity(force_N=[0, 0, -200])
    ...
    scene.getBody("hub").setVelocity([0, 0, -1])
...
class ConstantGravity(sysModel.SysModel):
    ...
    forceOutMsg : messaging.ForceMsg
    ...
    def __init__(self, force_N: Sequence[float], *args: Any):
        ...
        self.forceOutMsg = messaging.ForceMsg()
    ...
    def UpdateState(self, CurrentSimNanos: int):
        ...
        payload = messaging.ForceMsgPayload()
        payload.force = force_B
