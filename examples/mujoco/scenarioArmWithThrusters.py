...
START = 0
ARM_1_DEPLOY = 5
ARM_2_DEPLOY = ARM_1_DEPLOY + 10
ARM_3_DEPLOY = ARM_2_DEPLOY + 5
FIRST_THRUST = ARM_3_DEPLOY + 32.5
FIRST_ROLL = FIRST_THRUST + 10
SECOND_THRUST = FIRST_ROLL + 30
SECOND_ROLL = SECOND_THRUST + 5
ARM_4_DEPLOY = SECOND_ROLL + 5
THIRD_THRUST = ARM_4_DEPLOY + 30
END = THIRD_THRUST
