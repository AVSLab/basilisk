...
export STOCHEFF_ACCOUNT="${STOCHEFF_ACCOUNT:-ucbXXX_ascN}"
...
export BASILISK_ROOT="${BASILISK_ROOT:-/projects/$USER/basilisk}"
...
if [[ "$STOCHEFF_PYMODE" == "conda" ]]; then
    ...
    # venv mode: the prebuilt virtualenv carries its own Python + compiled MuJoCo.
