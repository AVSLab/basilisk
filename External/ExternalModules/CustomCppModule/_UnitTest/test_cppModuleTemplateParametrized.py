...
from Basilisk.ExternalModules import customCppModule                # import the module that is to be tested
...
def fswModuleTestFunction(show_plots, param1, param2, accuracy):
    ...
    module = customCppModule.CustomCppModule()   # update with current values
    module.ModelTag = "customCppModule"            # update python name of test module
    ...
    inputMessageData = messaging.CustomModuleMsgPayload() # Create a structure for the input message
    inputMessageData.dataVector = [param1, param2, 0.7]       # Set up a list as a 3-vector
    inputMsg = messaging.CustomModuleMsg().write(inputMessageData)
